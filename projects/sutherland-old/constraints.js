...
import {TAU, forDebugging, generateId, normalizeAngle, sets} from "./helpers.js";
...
class LLDistance extends LowLevelConstraint {
  constructor(constraint, a, b) {
    ...
    this.a = a;
    this.b = b;
    this.variables.push(variable(Vec.dist(a, b), {
      object: constraint,
      property: "distance"
...
class LLAngle extends LowLevelConstraint {
  constructor(constraint, a, b) {
    ...
    this.a = a;
    this.b = b;
    this.variables.push(variable(Vec.angle(Vec.sub(b, a)), {
      object: constraint,
      property: "angle"
    }), a.xVariable, a.yVariable, b.xVariable, b.yVariable);
...
const _Pin = class extends Constraint {
...
const _Finger = class extends Constraint {
  constructor(handle, position) {
    super();
    this.handle = handle;
    this.position = position;
...
function getHandleToFingerMap(constraints) {
