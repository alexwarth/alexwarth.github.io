...
(async () => {
  var _t2, _e2, _n2, _r2, _s2, _pu_instances, i_get, a_get, o_fn, c_fn, _t3, _e3, _n3, _r3, _s3, _i2, _Eu_instances, a_fn, o_fn2, _t4, _e4, _n4, _r4, _s4, _i3, _a2, _t5, _e5, _n5, _r5, _s5, _Fu_instances, i_fn, a_fn2, o_fn3, c_fn2, _t6, _e6, _n6, _r6, _s6, _i4, _a3, _o2, _c2, _Lu_instances, g_fn, p_fn, y_fn, u_fn, b_fn, m_fn, d_fn, l_fn, h_fn, f_fn, __fn, _t7, _e7, _n7, _Hu_instances, r_fn, s_fn, i_fn2, _t8, _e8, _n8, _r7, _s7, _Nu_instances, i_fn3, _a4, o_fn4, c_fn3, _t9, _e9, _n9, _sh_instances, r_fn2;
  (function() {
  ...
  let Bt, On, Je, tn;
  function pa(t, e, n, r) {
    Bt = t, window.looper = Bt, On = e, Je = n, tn = r, Bt.port.onmessage = (o) => ya(o.data);
    const s = _s().deviceSpecificLatencyOffset[On] ?? 20;
    Kt({
      command: "set latency offset",
      value: s
    }), window.addEventListener("keydown", ma), window.addEventListener("keyup", wa), window.addEventListener("pointerdown", (o) => xa(o.x / devicePixelRatio, o.y / devicePixelRatio, o)), window.addEventListener("pointermove", (o) => Sa(o.x / devicePixelRatio, o.y / devicePixelRatio));
    function i() {
  ...
  function ya(t) {
    switch (t.event) {
      ...
      case "finished recording":
        ...
        }), Je.samplesAsFloats.set(t.layer.id, new Float32Array(t.samples));
        break;
      case "changed latency offset":
        Rn(`latency offset = ${t.value}`), ga((e) => {
  ...
  function ps(t) {
    ...
    const n = Je.shared.layers.find((r) => r.id === e);
    gt = {
      id: e,
  ...
  function Sa(t, e) {
    if (st.x = t, st.y = e, gt === null) return;
    const { id: n, origPos: r, origGain: s } = gt;
    ba(n, (i) => {
      const o = -(st.y - r.y);
      i.gain = Math.max(0, Math.min(s + o / ms, 1));
    });
  }
  function ys() {
    for (const t of Je.shared.layers) {
      const { topY: e, bottomY: n } = bs(t);
      if (e <= st.y && st.y <= n) return t.id;
    }
    return null;
  }
  ...
  function ka() {
    G.clearRect(0, 0, innerWidth, innerHeight), Aa(), Ca(), Ea();
  }
  const He = 32, ms = He / 2, Ot = 100;
  function Aa() {
    const t = Je.shared.layers, e = la(t);
    if (e === null) return;
    const n = (innerWidth - 2 * Ot) / e;
    let r = 2 * He;
    const s = Ot, i = s + e * n;
    for (let a = 0; a < t.length; a++) {
      const c = t[a], f = bs(c), u = c.muted ? 0.25 : 1;
      let d = r;
      for (let b = 0; b < c.numFramesRecorded / e; b++) {
        let v = r, S = s + (c.frameOffset + e) % e * n;
        for (let j = 0; j < f.maxAmplitudesInChunks.length; j++) {
          S >= i && (S = s, v += He), G.lineWidth = Cn * n, G.strokeStyle = `rgba(100, 149, 237, ${u})`, G.beginPath();
          const D = f.maxAmplitudesInChunks[j] / f.maxAmplitudeInLayer * He / 2;
      ...
      }, f.topY = (r - He / 2) / devicePixelRatio, f.bottomY = (d + He / 2) / devicePixelRatio, G.fillStyle = `rgba(100, 149, 237, ${u / 4})`, G.beginPath(), G.arc(_, l, c.gain * ms, 0, 2 * Math.PI), G.fill(), r = d + He * 1.15;
    }
    const o = Ot + Je.playhead * n;
  ...
  let Jt = "", vs = "cornflowerblue", Dr = 0;
  function Rn(t, e = "cornflowerblue", n = 3e3) {
    Jt = t, vs = e, Dr = Date.now() + n, setTimeout(() => {
      Date.now() >= Dr && (Jt = "");
    }, n);
  }
  function Ea() {
  ...
  const Oa = "" + new URL("worklet-ZAX7yFgr.js", import.meta.url).href, $e = Symbol.for("_am_meta"), it = Symbol.for("_am_trace"), ot = Symbol.for("_am_objectId"), nn = Symbol.for("_am_isProxy"), xs = Symbol.for("_am_clearCache"), Ta = Symbol.for("_am_uint"), Ra = Symbol.for("_am_int"), Ma = Symbol.for("_am_f64"), Ss = Symbol.for("_am_counter"), ja = Symbol.for("_am_text");
  class Me {
    constructor(e) {
      ...
      Reflect.defineProperty(this, ja, {
        value: true
      });
    }
    get length() {
    ...
    switch (s) {
      ...
      case "undefined":
        throw new RangeError([
          `Cannot assign undefined value at ${Pr(n)}, `,
  ...
  const Pa = {
    get(t, e) {
      ...
      return e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === ot ? r : e === nn ? true : e === it ? t.trace : e === $e ? {
        handle: n,
        textV2: t.textV2
      } : (s[e] || (s[e] = ge(t, e)), s[e]);
    },
    ...
    get(t, e) {
      const { context: n, objectId: r } = t;
      return e = Ae(e), e === Symbol.hasInstance ? (s) => Array.isArray(s) : e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === ot ? r : e === nn ? true : e === it ? t.trace : e === $e ? {
        handle: n
      } : e === "length" ? n.length(r) : typeof e == "number" ? ge(t, e) : sr(t)[e];
    },
    set(t, e, n) {
      const { context: r, objectId: s, path: i, textV2: o } = t;
      ...
      switch (c) {
        ...
        case "text": {
          if (o) Gt(a), e >= r.length(s) ? r.insertObject(s, e, a) : r.putObject(s, e, a);
            ...
            let f;
            ir(a), e >= r.length(s) ? f = r.insertObject(s, e, "") : f = r.putObject(s, e, ""), bt(r, f, [
              ...i,
              e
            ]).splice(0, 0, ...a);
          }
    ...
    get(t, e) {
      ...
      return e = Ae(e), e === Symbol.hasInstance ? (s) => Array.isArray(s) : e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === ot ? r : e === nn ? true : e === it ? t.trace : e === $e ? {
        handle: n
      } : e === "length" ? n.length(r) : typeof e == "number" ? ge(t, e) : Fa(t)[e] || sr(t)[e];
    },
    getPrototypeOf() {
  ...
  function At(t, e, n, r) {
    ...
    return Object.assign(i, s), new Proxy(i, Pa);
  }
  function sn(t, e, n, r) {
    const s = {
      context: t,
  ...
  function bt(t, e, n) {
    ...
    return Object.assign(s, r), new Proxy(s, $a);
  }
  function Ba(t, e) {
    return At(t, "_root", e, []);
  }
  ...
  function Fa(t) {
    ...
    return {
      ...
      insertAt(s, ...i) {
        i.every((o) => typeof o == "string") ? e.splice(n, s, 0, i.join("")) : sr(t).insertAt(s, ...i);
      }
    };
  }
  function ir(t) {
  ...
  const Na = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
  function on(t) {
  ...
  const Va = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), $r = {
    randomUUID: Va
  };
  function Es(t, e, n) {
    if ($r.randomUUID && !e && !t) return $r.randomUUID();
    t = t || {};
    const r = t.random || (t.rng || Ha)();
  ...
  hn.encodeInto;
  const Ka = typeof TextDecoder < "u" ? new TextDecoder("utf-8", {
    ignoreBOM: true,
    fatal: true
  }) : {
    decode: () => {
  ...
  typeof TextDecoder < "u" && Ka.decode();
  ...
  function ae(t, e = true) {
    ...
    if (n === void 0 || n == null || e && Ga(t) !== "_root") throw new RangeError("must be the document root");
    return n;
  }
  function Os(t) {
    return Reflect.get(t, it);
  }
  function Ga(t) {
    return typeof t != "object" || t === null ? null : Reflect.get(t, ot);
  }
  function an(t) {
  ...
  function ar(t) {
    const e = or(t), n = !!e.freeze, r = e.patchCallback, s = !e.enableTextV2, i = e.actor, o = de.create({
      actor: i,
      text_v1: s
    });
  ...
  function Xa(t, e) {
    const n = ae(t), r = n.heads, s = or(e), i = n.handle.fork(s.actor, r);
    i.updateDiffCursor();
    const o = Ya(n, [
      "heads"
    ]);
  ...
  function Za(t, e) {
    return mt(ar(e), "from", {}, (n) => Object.assign(n, t)).newDoc;
  }
  function Qa(t, e, n) {
  ...
  function nc(t, e) {
    const n = or(e), r = n.actor, s = n.patchCallback, i = !n.enableTextV2, o = n.unchecked || false, a = n.allowMissingChanges || false, c = n.convertRawStringsToText || false, f = de.load(t, {
      text_v1: i,
      actor: r,
      unchecked: o,
      allowMissingDeps: a,
  ...
  function cn(t) {
    const e = fn(t);
    return e.enableTextV2 = true, ar(e);
  }
  function Lr(t, e) {
    const n = fn(e);
    return n.enableTextV2 = true, Xa(t, n);
  }
  function dc(t, e) {
    const n = fn(e);
  ...
  function lc(t, e) {
    const n = fn(e);
    return n.enableTextV2 = true, n.patchCallback ? Ts(ar(n), t) : nc(t, n);
  }
  function fn(t) {
    return {
      actor: t
  ...
  function gc(t) {
    n.debug = n, n.default = n, n.coerce = c, n.disable = o, n.enable = s, n.enabled = a, n.humanize = _c(), n.destroy = f, Object.keys(t).forEach((u) => {
      n[u] = t[u];
  ...
  const Ps = ".", xc = "", $s = "", Sc = "#", Pn = "*", Bs = "xstate.init", $n = "xstate.stop";
  function kc(t, e) {
    return {
  ...
  const Ic = typeof Symbol == "function" && Symbol.observable || "@@observable";
  function Ls(t, e) {
    const n = zr(t), r = zr(e);
 ...
 - ${s}: ${i.toString().replace(/\n\s*/g, "")}`).join("")}`), t);
  ...
  class jc {
    constructor(e, n) {
      ...
      this.system = o ? o.system : Rc(this, {
        clock: s,
        logger: i
    ...
    update(e, n) {
      ...
      switch (this._snapshot.status) {
        ...
        case "done":
          ...
          this._stopProcedure(), this._complete(), this._doneEvent = Ac(this.id, this._snapshot.output), this._parent && this.system._relay(this, this._parent, this._doneEvent);
          break;
        case "error":
    ...
    _error(e) {
      this._stopProcedure(), this._reportError(e), this._parent && this.system._relay(this, this._parent, Ec(this.id, e));
    }
    _stopProcedure() {
      return this._processingStatus !== fe.Running ? this : (this.system.scheduler.cancelAll(this), this.mailbox.clear(), this.mailbox = new Nr(this._process.bind(this)), this._processingStatus = fe.Stopped, this.system._unregister(this), this);
    }
    _send(e) {
...
Event: ${n}`);
  ...
  function Pc(t) {
    ...
    return e.type = "xstate.cancel", e.sendId = t, e.resolve = Dc, e.execute = Uc, e;
  }
  function $c(t, e, n, r, { id: s, systemId: i, src: o, input: a, syncSnapshot: c }) {
    const f = typeof o == "string" ? ur(e.machine, o) : o, u = typeof s == "function" ? s(n) : s;
    let d, _;
  ...
  function Bc(t, { actorRef: e }) {
    e && t.defer(() => {
      e._processingStatus !== fe.Stopped && e.start();
    });
  }
  function Fc(...[t, { id: e, systemId: n, input: r, syncSnapshot: s = false } = {}]) {
    function i(o, a) {
      throw new Error("This isn't supposed to be called");
    }
    return i.type = "xstate.spawnChild", i.id = e, i.systemId = n, i.src = t, i.input = r, i.syncSnapshot = s, i.resolve = $c, i.execute = Bc, i;
  }
  function Lc(t, e, n, r, { actorRef: s }) {
  ...
  function Ws(t) {
    ...
    return e.type = "xstate.stopChild", e.actorRef = t, e.resolve = Lc, e.execute = Hc, e;
  }
  function lr(t, e, n, r) {
    ...
    if (typeof o != "function") return lr(o, e, n, r);
    const a = {
      context: e,
      event: n
  ...
  const hr = (t) => t.type === "atomic" || t.type === "final";
  function at(t) {
  ...
  function Yt(t) {
    ...
    for (const r of e) if (r.type === "compound" && (!n.get(r) || !n.get(r).length)) Jr(r).forEach((s) => e.add(s));
    else if (r.type === "parallel") {
      for (const s of at(r)) if (s.type !== "history" && !e.has(s)) {
        const i = Jr(s);
  ...
  function _r(t, e) {
    return e.type === "compound" ? at(e).some((n) => n.type === "final" && t.has(n)) : e.type === "parallel" ? at(e).every((n) => _r(t, n)) : e.type === "final";
  }
  const un = (t) => t[0] === Sc;
  function Nc(t, e) {
  ...
  function ze(t, e, n) {
    const r = zs(n.target), s = n.reenter ?? false, i = Kc(t, r);
  ...
  function Wc(t) {
    ...
    if (t.config.on) for (const n of Object.keys(t.config.on)) {
      ...
      e.set(n, et(r).map((s) => ze(t, n, s)));
    }
    if (t.config.onDone) {
      const n = `xstate.done.state.${t.id}`;
      e.set(n, et(t.config.onDone).map((r) => ze(t, n, r)));
    }
    for (const n of t.invoke) {
      if (n.onDone) {
        const r = `xstate.done.actor.${n.id}`;
        e.set(r, et(n.onDone).map((s) => ze(t, r, s)));
      }
      if (n.onError) {
        const r = `xstate.error.actor.${n.id}`;
        e.set(r, et(n.onError).map((s) => ze(t, r, s)));
      }
      if (n.onSnapshot) {
        const r = `xstate.snapshot.${n.id}`;
        e.set(r, et(n.onSnapshot).map((s) => ze(t, r, s)));
      }
    }
...
${i.message}`);
  ...
  function Gs(t) {
    ...
    function n(r) {
      if (!e.has(r)) {
        ...
        else if (r.type === "parallel") for (const s of at(r)) n(s);
      }
    }
    return n(t), e;
  }
  ...
  function Zt(t, e) {
    ...
    const n = Object.keys(e), r = n.map((s) => ct(t, s)).filter(Boolean);
    return [
      t.machine.root,
      t
  ...
  function Jc(t, e, n, r) {
    const i = ct(t, e).next(n, r);
    return !i || !i.length ? t.next(n, r) : i;
  }
  function qc(t, e, n, r) {
    const s = Object.keys(e), i = ct(t, s[0]), o = gr(i, e[s[0]], n, r);
  ...
  function Gc(t, e, n, r) {
    ...
    for (const i of Object.keys(e)) {
      const o = e[i];
      if (!o) continue;
      const a = ct(t, i), c = gr(a, o, n, r);
      c && s.push(...c);
    }
    return s.length ? s : t.next(n, r);
  }
  function gr(t, e, n, r) {
    return typeof e == "string" ? Jc(t, e, n, r) : Object.keys(e).length === 1 ? qc(t, e, n, r) : Gc(t, e, n, r);
  }
  function Yc(t) {
  ...
  function pr(t, e) {
    ...
    for (const r of t.target) if (Ve(r)) if (e[r.id]) for (const s of e[r.id]) n.add(s);
    else for (const s of pr(qs(r), e)) n.add(s);
    else n.add(r);
    return [
      ...n
    ];
  ...
  function Nn(t, e, n, r, s, i) {
    ...
    const c = Ys(t, o, a);
    let f = e;
    s || ([f, a] = rf(f, r, n, c, o, a, i, n.actionExecutor)), f = ft(f, r, n, c.flatMap((d) => d.actions), i, void 0), f = tf(f, r, n, c, o, i, a, s);
    const u = [
      ...o
    ];
    f.status === "done" && (f = ft(f, r, n, u.sort((d, _) => _.order - d.order).flatMap((d) => d.exit), i, void 0));
    try {
      return a === e.historyValue && Qc(e._nodes, o) ? f : qe(f, {
        _nodes: u,
        historyValue: a
      });
    } catch (d) {
  ...
  function tf(t, e, n, r, s, i, o, a) {
    let c = t;
    const f = /* @__PURE__ */ new Set(), u = /* @__PURE__ */ new Set();
    nf(r, o, u, f), a && u.add(t.machine.root);
    ...
    for (const _ of [
      ...
      const l = [];
      l.push(..._.entry);
      for (const b of _.invoke) l.push(Fc(b.src, {
        ...b,
      ...
      if (c = ft(c, e, n, l, i, _.invoke.map((b) => b.id)), _.type === "final") {
        const b = _.parent;
        let v = (b == null ? void 0 : b.type) === "parallel" ? b : b == null ? void 0 : b.parent, S = v || _;
        for ((b == null ? void 0 : b.type) === "compound" && i.push(Bn(b.id, _.output !== void 0 ? Fn(_.output, c.context, e, n.self) : void 0)); (v == null ? void 0 : v.type) === "parallel" && !d.has(v) && _r(s, v); ) d.add(v), i.push(Bn(v.id)), S = v, v = v.parent;
        if (v) continue;
        c = qe(c, {
          status: "done",
          output: ef(c, e, n, c.machine.root, S)
        });
      }
    }
    return c;
  ...
  function nf(t, e, n, r) {
    for (const s of t) {
      const i = Xs(s, e);
      for (const a of s.target || []) !Ve(a) && (s.source !== a || s.source !== i || s.reenter) && (r.add(a), n.add(a)), nt(a, e, n, r);
      const o = pr(s, e);
      for (const a of o) {
        const c = It(a, i);
  ...
  function nt(t, e, n, r) {
    ...
    if (Ve(t)) if (e[t.id]) {
      const s = e[t.id];
      for (const i of s) r.add(i), nt(i, e, n, r);
      for (const i of s) gn(i, t.parent, r, e, n);
    } else {
      const s = qs(t);
      for (const i of s.target) r.add(i), s === ((_a5 = t.parent) == null ? void 0 : _a5.initial) && n.add(t.parent), nt(i, e, n, r);
      for (const i of s.target) gn(i, t.parent, r, e, n);
    }
    else if (t.type === "compound") {
      const [s] = t.initial.target;
      Ve(s) || (r.add(s), n.add(s)), nt(s, e, n, r), gn(s, t, r, e, n);
    } else if (t.type === "parallel") for (const s of at(t).filter((i) => !Ve(i))) [
      ...r
    ].some((i) => Fe(i, s)) || (Ve(s) || (r.add(s), n.add(s)), nt(s, e, n, r));
  }
  function Zs(t, e, n, r, s) {
    for (const i of r) if ((!s || Fe(i, s)) && t.add(i), i.type === "parallel") for (const o of at(i).filter((a) => !Ve(a))) [
      ...t
    ].some((a) => Fe(a, o)) || (t.add(o), nt(o, e, n, t));
  }
  ...
  function rf(t, e, n, r, s, i, o, a) {
    ...
    let u;
    for (const d of f) for (const _ of Yc(d)) {
      let l;
      _.history === "deep" ? l = (b) => hr(b) && Fe(b, d) : l = (b) => b.parent === d, u ?? (u = {
        ...i
      }), u[_.id] = Array.from(s).filter(l);
    }
    for (const d of f) c = ft(c, e, n, [
      ...d.exit,
  ...
  function Qs(t, e, n, r, s, i) {
    ...
    let a = t;
    for (const c of r) {
      const f = typeof c == "function", u = f ? c : sf(o, typeof c == "string" ? c : c.type), d = {
        context: a.context,
        event: e,
        self: n.self,
        system: n.system
  ...
  function pn(t, e, n, r) {
    ...
    if (e.type === $n) return s = qe(qr(s, e, n), {
      status: "stopped"
    }), o(s, e, []), {
      snapshot: s,
      microstates: i
  ...
  function qr(t, e, n) {
    return ft(t, e, n, Object.values(t.children).map((r) => Ws(r)), [], void 0);
  }
  function Gr(t, e) {
    return e.machine.getTransitionData(e, t);
  }
  function of(t, e) {
    const n = /* @__PURE__ */ new Set(), r = t._nodes.filter(hr);
    for (const s of r) e: for (const i of [
      s
    ].concat(It(s, void 0))) if (i.always) {
      for (const o of i.always) if (o.guard === void 0 || lr(o.guard, t.context, e, t)) {
        n.add(o);
        break e;
      }
    }
  ...
  function gf(t, e, n, r, { event: s, id: i, delay: o }, { internalQueue: a }) {
  ...
  function yf(t, e) {
    ...
    return n.type = "xstate.raise", n.event = t, n.id = e == null ? void 0 : e.id, n.delay = e == null ? void 0 : e.delay, n.resolve = gf, n.execute = pf, n;
  }
  ...
  class yr {
    constructor(e, n) {
      if (this.config = e, this.key = void 0, this.id = void 0, this.type = void 0, this.path = void 0, this.states = void 0, this.history = void 0, this.entry = void 0, this.exit = void 0, this.parent = void 0, this.machine = void 0, this.meta = void 0, this.output = void 0, this.order = -1, this.description = void 0, this.tags = [], this.transitions = void 0, this.always = void 0, this.parent = n._parent, this.key = n._key, this.machine = n._machine, this.path = this.parent ? this.parent.path.concat(this.key) : [], this.id = this.config.id || [
        this.machine.id,
        ...this.path
      ].join(Ps), this.type = this.config.type || (this.config.states && Object.keys(this.config.states).length ? "compound" : this.config.history ? "history" : "atomic"), this.description = this.config.description, this.order = this.machine.idMap.size, this.machine.idMap.set(this.id, this), this.states = this.config.states ? Wr(this.config.states, (r, s) => new yr(r, {
        _parent: this,
        _key: s,
    ...
    _initialize() {
      this.transitions = Wc(this), this.config.always && (this.always = et(this.config.always).map((e) => ze(this, $s, e))), Object.keys(this.states).forEach((e) => {
    ...
    get definition() {
      return {
        ...
        states: Wr(this.states, (e) => e.definition),
        on: this.on,
        transitions: [
          ...this.transitions.values()
        ].flat().map((e) => ({
          ...e,
          actions: e.actions.map(dt)
        })),
    ...
    get invoke() {
      return Xe(this, "invoke", () => Re(this.config.invoke).map((e, n) => {
    ...
    get after() {
      return Xe(this, "delayedTransitions", () => zc(this));
    }
    get initial() {
      return Xe(this, "initial", () => Vc(this, this.config.initial));
    }
    next(e, n) {
      const r = n.type, s = [];
      let i;
      const o = Xe(this, `candidates-${r}`, () => Nc(this, r));
      for (const a of o) {
...
${d.message}`);
  ...
  class br {
    ...
    resolveState(e) {
      const n = af(this.root, e.value), r = Yt(Zt(this.root, n));
      return Lt({
        _nodes: [
          ...r
        ],
        context: e.context || {},
        children: {},
        status: _r(r, this.root) ? "done" : e.status || "active",
        output: e.output,
        error: e.error,
    ...
    getTransitionData(e, n) {
      return gr(this.root, e.value, e, n) || [];
    }
    getPreInitialState(e, n, r) {
      ...
      return typeof s == "function" ? ft(i, n, e, [
    ...
    getStateNodeById(e) {
      const n = fr(e), r = n.slice(1), s = un(n[0]) ? n[0].slice(xf.length) : n[0], i = this.idMap.get(s);
    ...
    restoreSnapshot(e, n) {
      ...
      Object.keys(s).forEach((c) => {
        const f = s[c], u = f.snapshot, d = f.src, _ = typeof d == "string" ? ur(this, d) : d;
        if (!_) return;
        const l = wt(_, {
          id: c,
          parent: n.self,
        ...
        if (!o.has(c)) {
          ...
          for (const u in c) {
            ...
            if (d && typeof d == "object") {
              if ("xstate$$type" in d && d.xstate$$type === dr) {
                c[u] = f[d.id];
                continue;
              }
              a(d, f);
  ...
  class jf extends lt.Hash {
    constructor(e, n, r, s) {
      super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = (0, lt.createView)(this.buffer);
    }
    update(e) {
      (0, yn.aexists)(this);
    ...
    digestInto(e) {
      ...
      const a = (0, lt.createView)(e), c = this.outputLen;
  ...
  const bn = Ye, _e = mr, Df = new Uint32Array([
    1116352408,
    1899447441,
    3049323471,
    3921009573,
  ...
  class wr extends bn.HashMD {
    ...
    process(e, n) {
      ...
      for (let d = 0; d < 64; d++) {
        const _ = (0, _e.rotr)(a, 6) ^ (0, _e.rotr)(a, 11) ^ (0, _e.rotr)(a, 25), l = u + _ + (0, bn.Chi)(a, c, f) + Df[d] + Ue[d] | 0, v = ((0, _e.rotr)(r, 2) ^ (0, _e.rotr)(r, 13) ^ (0, _e.rotr)(r, 22)) + (0, bn.Maj)(r, s, i) | 0;
  ...
  Be.sha256 = (0, _e.wrapConstructor)(() => new wr());
  Be.sha224 = (0, _e.wrapConstructor)(() => new Uf());
  function Pf(t) {
  ...
  var $f = Pf;
  const Bf = $f, Ff = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
  var Lf = Bf(Ff), mn = Lf, Hf = function(t) {
    function e(i) {
  ...
  var Wf = Nf(zf);
  const ri = cr(Wf), vr = "automerge:", xr = (t) => {
    const e = new RegExp(`^${vr}(\\w+)$`), [, n] = t.match(e) || [], r = n, s = oi(r);
    ...
    if (!t || !t.startsWith(vr)) return false;
    const e = t;
    try {
      const { documentId: n } = xr(e);
      return ii(n);
    } catch {
      return false;
    }
    ...
    if (si(t)) return xr(t).documentId;
    if (ii(t)) return t;
    if (Vf(t)) {
  ...
  let U, Ke, x = 0;
  const Jf = 105, qf = 57342, Gf = 57343, Zr = 57337, Qr = 6, Ze = {};
  let ht = 11281e4, Ce = 1681e4, V = {}, ee, Qt, en = 0, vt = 0, re, pe, te = [], Jn = [], ue, oe, _t, es = {
    useRecords: false,
    mapsAsObjects: true
  }, xt = false, ai = 2;
  try {
  ...
  class St {
    ...
    decode(e, n) {
      if (U) return di(() => (Xn(), this ? this.decode(e, n) : St.prototype.decode.call(es, e, n)));
      Ke = n > -1 ? n : e.length, x = 0, vt = 0, Qt = null, re = null, U = e;
      try {
      ...
      if (this instanceof St) {
        ...
        (!ee || ee.length > 0) && (ee = []);
      } else V = es, (!ee || ee.length > 0) && (ee = []), ue = null;
      return Rt();
    }
    decodeMultiple(e, n) {
      let r, s = 0;
      try {
        let i = e.length;
        xt = true;
        let o = this ? this.decode(e, i) : Er.decode(e, i);
        if (n) {
          if (n(o) === false) return;
  ...
  function Rt() {
    try {
      ...
      if (x == Ke) ee = null, U = null, pe && (pe = null);
      else if (x > Ke) {
  ...
  function K() {
      ...
      case 31:
        switch (e) {
          ...
          case 4:
            let n = [], r, s = 0;
            for (; (r = K()) != Ze; ) {
              if (s >= ht) throw new Error(`Array length exceeds ${ht}`);
              n[s++] = r;
            }
          ...
          case 5:
            ...
            if (V.mapsAsObjects) {
              ...
              _t && (V.mapsAsObjects = true, _t = false);
    ...
    switch (e) {
      ...
      case 3:
        ...
        if (vt == 0 && Ke < 140 && t < 32) {
          let s = t < 16 ? ci(t) : Xf(t);
          if (s != null) return s;
        }
        return Yf(t);
      case 4:
        if (t >= ht) throw new Error(`Array length exceeds ${ht}`);
        let n = new Array(t);
        for (let s = 0; s < t; s++) n[s] = K();
        return n;
      case 5:
        if (t >= Ce) throw new Error(`Map size exceeds ${ht}`);
        if (V.mapsAsObjects) {
          let s = {};
        ...
        if (t >= Zr) {
          ...
          if (t < 65536) {
            if (t == Gf) {
              ...
              return K();
            } else if (t == Zr) return iu();
            if (V.getShared && (kr(), s = ee[t & 8191], s)) return s.read || (s.read = qn(s)), s.read();
          }
        }
        let r = te[t];
  ...
  function qn(t) {
    ...
    function e() {
      ...
      if (this.slowReads++ >= ai) {
        ...
        return r = V.keyMap ? new Function("r", "return {" + i.map((o) => V.decodeKey(o)).map((o) => ts.test(o) ? ye(o) + ":r()" : "[" + JSON.stringify(o) + "]:r()").join(",") + "}") : new Function("r", "return {" + i.map((o) => ts.test(o) ? ye(o) + ":r()" : "[" + JSON.stringify(o) + "]:r()").join(",") + "}"), this.compiledReader && (r.next = this.compiledReader), r.propertyCount = n, this.compiledReader = r, r(K);
      }
      let s = {};
  ...
  te[14] = (t) => re ? re[0].slice(re.position0, re.position0 += t) : new Ge(t, 14);
  te[15] = (t) => re ? re[1].slice(re.position1, re.position1 += t) : new Ge(t, 15);
  let eu = {
    Error,
    RegExp
  };
  te[27] = (t) => (eu[t[0]] || Error)(t[1], t[2]);
  const ui = (t) => {
    if (U[x++] != 132) {
  ...
  te[51] = ui;
  te[Qr] = (t) => {
    if (!ue) if (V.getShared) kr();
    else return new Ge(t, Qr);
  ...
  te[258] = (t) => new Set(t);
  (te[259] = (t) => (V.mapsAsObjects && (V.mapsAsObjects = false, _t = true), t())).handlesRead = true;
  function Qe(t, e) {
  ...
  const tu = 1399353956;
  Jn.push((t, e) => {
    if (t >= 225 && t <= 255) return Qe(Ne().prefixes[t - 224], e);
    if (t >= 28704 && t <= 32767) return Qe(Ne().prefixes[t - 28672], e);
    if (t >= 1879052288 && t <= 2147483647) return Qe(Ne().prefixes[t - 1879048192], e);
    if (t >= 216 && t <= 223) return Qe(e, Ne().suffixes[t - 216]);
    if (t >= 27647 && t <= 28671) return Qe(e, Ne().suffixes[t - 27639]);
    if (t >= 1811940352 && t <= 1879048191) return Qe(e, Ne().suffixes[t - 1811939328]);
    if (t == tu) return {
      packedValues: ue,
  ...
  const nu = new Uint8Array(new Uint16Array([
    1
  ]).buffer)[0] == 1, ns = [
    Uint8Array,
    Uint8ClampedArray,
  ...
  for (let t = 0; t < ns.length; t++) su(ns[t], ru[t]);
  function su(t, e) {
  ...
  function di(t) {
    let e = Ke, n = x, r = en, s = vt, i = Qt, o = pe, a = re, c = new Uint8Array(U.slice(0, Ke)), f = ee, u = V, d = xt, _ = t();
    return Ke = e, x = n, en = r, vt = s, Qt = i, pe = o, re = a, U = c, xt = d, ee = f, V = u, oe = new DataView(U.buffer, U.byteOffset, U.byteLength), _;
  }
  function Xn() {
    U = null, pe = null, ee = null;
  }
  const Ar = new Array(147);
  for (let t = 0; t < 256; t++) Ar[t] = +("1e" + Math.floor(45.15 - t * 0.30103));
  let Er = new St({
    useRecords: false
  });
  const li = Er.decode;
  ...
  let Zn, hi;
  const ln = typeof globalThis == "object" && globalThis.Buffer, Ct = typeof ln < "u", vn = Ct ? ln.allocUnsafeSlow : Uint8Array, rs = Ct ? ln : Uint8Array, ss = 256, is = Ct ? 4294967296 : 2144337920;
  let xn, m, Q, g = 0, Pe, ne = null;
  const ou = 61440, au = /[\u0080-\uFFFF]/, le = Symbol("record-id");
  class _i extends St {
    constructor(e) {
      super(e), this.offset = 0;
      let n, r, s, i, o;
      e = e || {};
      let a = rs.prototype.utf8Write ? function(p, R, k) {
      ...
      this.mapEncode = function(p, R) {
        ...
        if (m || (m = new vn(8192), Q = new DataView(m.buffer, 0, 8192), g = 0), Pe = m.length - 10, Pe - g < 2048 ? (m = new vn(m.length), Q = new DataView(m.buffer, 0, m.length), Pe = m.length - 10, g = 0) : R === cs && (g = g + 7 & 2147483640), n = g, c.useSelfDescribedHeader && (Q.setUint32(g, 3654940416), g += 3), o = c.structuredClone ? /* @__PURE__ */ new Map() : null, c.bundleStrings && typeof p != "string" ? (ne = [], ne.size = 1 / 0) : ne = null, r = c.structures, r) {
          if (r.uninitialized) {
            let C = c.getShared() || {};
        ...
        try {
          if (xn) return;
          if (E(p), ne && as(n, E), c.offset = g, o && o.idsToInsert) {
            g += o.idsToInsert.length * 2, g > Pe && H(g), c.offset = g;
            let k = uu(m.subarray(n, g), o.idsToInsert);
            return o = null, k;
          }
          return R & cs ? (m.start = n, m.end = g, m) : m.subarray(n, g);
        } finally {
          if (r) {
      ...
      const E = (p) => {
        ...
        if (R === "string") {
          ...
          if (ne && C >= 4 && C < 1024) {
            if ((ne.size += C) > ou) {
              ...
              g + z > Pe && (m = H(g + z)), m[g++] = 217, m[g++] = 223, m[g++] = 249, m[g++] = ne.position ? 132 : 130, m[g++] = 26, N = g - n, g += 4, ne.position && as(n, E), ne = [
                "",
                ""
          ...
          if ((C = this.useFloat32) > 0 && p < 4294967296 && p >= -2147483648) {
            ...
            let O;
            if (C < 4 || (O = p * Ar[(m[g] & 127) << 1 | m[g + 1] >> 7]) >> 0 === O) {
              g += 4;
              return;
            } else g--;
          }
        ...
        if (this.keyMap) {
          ...
          for (let J = 0; J < B; J++) {
            let Rr = N[J];
            k = C[Rr], k || (k = C[Rr] = /* @__PURE__ */ Object.create(null), O++), C = k;
          }
        ...
        if (z !== void 0) z &= 65535, m[g++] = 217, m[g++] = z >> 8 | 224, m[g++] = z & 255;
          ...
          if (C[le] = z, Q.setUint32(g, 3655335680), g += 3, O && (j += D * O), S.length >= ss - u && (S.shift()[le] = void 0), S.push(C), Se(B + 2), E(57344 + z), E(N), R) return;
        ...
        let R;
        if (p > 16777216) {
          if (p - n > is) throw new Error("Encoded buffer would be larger than maximum buffer size");
          R = Math.min(is, Math.round(Math.max((p - n) * (p > 67108864 ? 1.25 : 2), 4194304) / 4096) * 4096);
      ...
      function* W(p, R, k) {
        ...
        if (C === Object) {
          ...
          O ? L(p, true) : os(Object.keys(p).length, 160);
          for (let B in p) {
            let F = p[B];
          ...
          m[g++] = 255;
        } else Sn(p) ? (os(p.size, 64), yield m.subarray(n, g), yield p, Z()) : p[Symbol.asyncIterator] ? (m[g++] = 159, yield m.subarray(n, g), yield p, Z(), m[g++] = 255) : E(p);
  ...
  const fu = new Uint8Array(new Uint16Array([
    1
  ]).buffer)[0] == 1;
  hi = [
    Date,
    ...
    ve(86, 8),
    {
      encode(t, e) {
        ...
        if (r) {
          ...
          let s = r.slice(0);
          s.unshift(57344), s.push(new Ge(t.version, 1399353956)), e(s);
        } else e(new Ge(t.version, 1399353956));
      }
    }
  ];
  function ve(t, e) {
  ...
  Ir.encode;
  Ir.encodeAsIterable;
  Ir.encodeAsAsyncIterable;
  const cs = 512, du = 1024, kn = 2048;
  function pi(t) {
    return new _i({
      tagUint8Array: false,
      useRecords: false
  ...
  const hu = (t, e) => t.length === e.length && t.every((n, r) => n === e[r]), Cr = (t, e) => hu(t, e), _u = async (t, e) => {
    let n;
    const r = new Promise((s, i) => {
      n = setTimeout(() => i(new gu(`withTimeout: timed out after ${e}ms`)), e);
    });
    try {
  ...
  class pu extends ut {
    constructor(e, n = {}) {
      ...
      s ? (r = dc(n.initialValue), r = tc(r)) : r = cn(), __privateSet(this, _t2, je(`automerge-repo:dochandle:${this.documentId.slice(0, 5)}`));
    ...
    async whenReady(e = [
      ...
      await _u(__privateMethod(this, _pu_instances, o_fn).call(this, e), __privateGet(this, _r2));
    }
    async doc(e = [
      "ready",
      "unavailable"
    ...
    heads() {
      if (this.isReady()) return we(__privateGet(this, _pu_instances, i_get));
    }
    update(e) {
  ...
  o_fn = function(e) {
    ...
    return Ef(__privateGet(this, _e2), (r) => n.some((s) => r.matches(s)), {
  ...
  }, { IDLE: uh, LOADING: dh, AWAITING_NETWORK: lh, REQUESTING: jt, READY: An, DELETED: hh, UNAVAILABLE: fs } = yu, bu = "CREATE", mu = "FIND", wu = "REQUEST", vu = "DOC_READY", xu = "AWAIT_NETWORK", Su = "NETWORK_READY", Dt = "UPDATE", ku = "DELETE", Au = "DOC_UNAVAILABLE";
  class Eu extends ut {
    constructor() {
      super(...arguments);
      __privateAdd(this, _Eu_instances);
    ...
    handleRemoteHeads(e) {
      ...
      const n = __privateMethod(this, _Eu_instances, o_fn2).call(this, e);
      ...
      for (const r of n) {
        ...
        if (s) for (const i of s) __privateMethod(this, _Eu_instances, a_fn).call(this, i, r.documentId) && this.emit("notify-remote-heads", {
          targetId: i,
          documentId: r.documentId,
          heads: r.remoteHeads,
          timestamp: r.timestamp,
    ...
    handleImmediateRemoteHeadsChanged(e, n, r) {
      ...
      if (o) for (const a of o) __privateMethod(this, _Eu_instances, a_fn).call(this, a, e) && this.emit("notify-remote-heads", {
        targetId: a,
        documentId: e,
        heads: r,
        timestamp: i,
  ...
  }, Iu = (t) => Ou(t) || bi(t) || yi(t) || Cu(t) || Tu(t) || Ru(t), Cu = (t) => t.type === "doc-unavailable", yi = (t) => t.type === "request", Ou = (t) => t.type === "sync", bi = (t) => t.type === "ephemeral", Tu = (t) => t.type === "remote-subscription-change", Ru = (t) => t.type === "remote-heads-changed", Mu = (t) => `${t.senderId}:${t.sessionId}`;
  class ju extends ut {
    constructor(e, n = Du(), r) {
      super();
  ...
  class Fu {
    ...
    async saveDoc(e, n) {
      if (!__privateMethod(this, _Fu_instances, o_fn3).call(this, e, n)) return;
      const r = __privateGet(this, _n5).get(e) ?? [];
      __privateMethod(this, _Fu_instances, c_fn2).call(this, r) ? await __privateMethod(this, _Fu_instances, a_fn2).call(this, e, n, r) : await __privateMethod(this, _Fu_instances, i_fn).call(this, e, n), __privateGet(this, _e5).set(e, we(n));
    }
    async removeDoc(e) {
  ...
  i_fn = async function(e, n) {
    const r = uc(n, __privateGet(this, _e5).get(e) ?? []);
    if (r && r.length > 0) {
      const s = [
        e,
        "incremental",
  ...
  class Lu extends xi {
    constructor({ handle: e, onLoadSyncState: n }) {
      ...
      __privateSet(this, _t6, je(`automerge-repo:docsync:${r}`)), e.on("change", er(() => __privateMethod(this, _Lu_instances, g_fn).call(this), this.syncDebounceRate)), e.on("ephemeral-message-outbound", (s) => __privateMethod(this, _Lu_instances, p_fn).call(this, s)), (async () => (await e.doc([
        An,
        jt
      ]), __privateMethod(this, _Lu_instances, __fn).call(this)))();
    }
    get peerStates() {
    ...
    beginSync(e) {
      const n = e.every((s) => __privateGet(this, _r6)[s] in [
        ...
        if (__privateSet(this, _a3, true), __privateMethod(this, _Lu_instances, f_fn).call(this), !(s === void 0 && n)) return s ?? cn();
      });
      __privateGet(this, _t6).call(this, `beginSync: ${e.join(", ")}`), e.forEach((s) => {
        __privateMethod(this, _Lu_instances, u_fn).call(this, s, (i) => {
          const o = js(Ms(i));
          __privateMethod(this, _Lu_instances, d_fn).call(this, s, o), r.then((a) => {
            a && __privateMethod(this, _Lu_instances, l_fn).call(this, s, a);
          }).catch((a) => {
    ...
    receiveMessage(e) {
      switch (e.type) {
        ...
        case "doc-unavailable":
          __privateGet(this, _r6)[e.senderId] = "unavailable", __privateMethod(this, _Lu_instances, f_fn).call(this);
          break;
        default:
    ...
    receiveSyncMessage(e) {
      ...
      __privateMethod(this, _Lu_instances, __fn).call(this), __privateMethod(this, _Lu_instances, h_fn).call(this, e);
    }
  }
  _t6 = new WeakMap();
  _e6 = new WeakMap();
  ...
  g_fn = async function() {
    ...
    e !== void 0 && __privateGet(this, _e6).forEach((n) => __privateMethod(this, _Lu_instances, l_fn).call(this, n, e));
  };
  p_fn = async function({ data: e }) {
    __privateGet(this, _t6).call(this, "broadcastToPeers", __privateGet(this, _e6)), __privateGet(this, _e6).forEach((n) => __privateMethod(this, _Lu_instances, y_fn).call(this, n, e));
  };
  y_fn = function(e, n) {
  ...
  u_fn = function(e, n) {
    __privateMethod(this, _Lu_instances, b_fn).call(this, e), e in __privateGet(this, _r6) || (__privateGet(this, _r6)[e] = "unknown");
    ...
    s || (__privateGet(this, _c2).call(this, e).then((i) => {
      __privateMethod(this, _Lu_instances, m_fn).call(this, e, i ?? cc());
    }).catch((i) => {
  ...
  l_fn = function(e, n) {
    __privateGet(this, _t6).call(this, `sendSyncMessage ->${e}`), __privateMethod(this, _Lu_instances, u_fn).call(this, e, (r) => {
      const [s, i] = oc(n, r);
      if (i) {
        __privateMethod(this, _Lu_instances, d_fn).call(this, e, s);
  ...
  h_fn = function(e) {
    yi(e) && (__privateGet(this, _r6)[e.senderId] = "wants"), __privateMethod(this, _Lu_instances, f_fn).call(this), fc(e.data).heads.length > 0 && (__privateGet(this, _r6)[e.senderId] = "has"), __privateMethod(this, _Lu_instances, u_fn).call(this, e.senderId, (n) => {
      __privateGet(this, _o2).update((r) => {
        const [s, i] = ac(r, n, e.data);
        return __privateMethod(this, _Lu_instances, d_fn).call(this, e.senderId, i), __privateMethod(this, _Lu_instances, l_fn).call(this, e.senderId, r), s;
      }), __privateMethod(this, _Lu_instances, f_fn).call(this);
    });
  };
  f_fn = function() {
  ...
  __fn = function() {
    for (const e of __privateGet(this, _i4)) __privateMethod(this, _Lu_instances, h_fn).call(this, e.message);
  ...
  class Hu extends xi {
    ...
    async receiveMessage(e) {
      ...
      const r = __privateMethod(this, _Hu_instances, r_fn).call(this, n);
      r.receiveMessage(e);
      const s = await __privateMethod(this, _Hu_instances, i_fn2).call(this, n);
      r.beginSync(s.filter((i) => !r.hasPeer(i)));
    }
    addDocument(e) {
      if (__privateGet(this, _n7)[e]) return;
      const n = __privateMethod(this, _Hu_instances, r_fn).call(this, e);
      __privateMethod(this, _Hu_instances, i_fn2).call(this, e).then((r) => {
        n.beginSync(r);
      });
    }
    removeDocument(e) {
  ...
  r_fn = function(e) {
    if (!__privateGet(this, _e7)[e]) {
      const n = this.repo.find(Sr({
        documentId: e
      }));
      __privateGet(this, _e7)[e] = __privateMethod(this, _Hu_instances, s_fn).call(this, n);
    }
  ...
  class Nu extends ut {
    constructor({ storage: e, network: n = [], peerId: r, sharePolicy: s, isEphemeral: i = e === void 0, enableRemoteHeadsGossiping: o = false } = {}) {
      ...
      }), __privateSet(this, _n8, new Hu(this)), __privateGet(this, _n8).on("message", (u) => {
      ...
      this.networkSubsystem = f, f.on("peer", async ({ peerId: u, peerMetadata: d }) => {
        ...
        __privateMethod(this, _Nu_instances, i_fn3).call(this, u);
      }), __privateGet(this, _n8).on("sync-state", (u) => {
        __privateMethod(this, _Nu_instances, o_fn4).call(this, u);
        const d = __privateGet(this, _e8)[u.documentId], { storageId: _ } = this.peerMetadataByPeerId[u.peerId] || {};
        if (!_) return;
        const l = d.getRemoteHeads(_);
        u.syncState.theirHeads && (!l || !Cr(l, u.syncState.theirHeads)) && u.syncState.theirHeads && (d.setRemoteHeads(_, u.syncState.theirHeads), _ && __privateGet(this, _s7) && __privateGet(this, _r7).handleImmediateRemoteHeadsChanged(u.documentId, _, u.syncState.theirHeads));
    ...
    create(e) {
      const { documentId: n } = xr(Kf()), r = __privateMethod(this, _Nu_instances, c_fn3).call(this, {
        documentId: n,
        isNew: true,
        initialValue: e
      });
    ...
    find(e) {
      ...
      const r = __privateMethod(this, _Nu_instances, c_fn3).call(this, {
        documentId: n,
        isNew: false
      });
      return this.emit("document", {
    ...
    delete(e) {
      const n = wn(e);
      __privateMethod(this, _Nu_instances, c_fn3).call(this, {
        documentId: n,
        isNew: false
    ...
    async export(e) {
      const n = wn(e), s = await __privateMethod(this, _Nu_instances, c_fn3).call(this, {
        documentId: n,
        isNew: false
      }).doc();
      if (s) return Rs(s);
  ...
  const Wu = "" + new URL("automerge_wasm_bg-BEjDkhWo.wasm", import.meta.url).href, Vu = async (t = {}, e) => {
    let n;
  ...
  let Wt = new Ju("utf-8");
  const qu = typeof Wt.encodeInto == "function" ? function(t, e) {
  ...
  function Ee(t, e, n) {
    ...
    if (o !== r) {
      ...
      const a = zt().subarray(s + o, s + r), c = qu(t, a);
  ...
  const Gu = typeof TextDecoder > "u" ? (0, module.require)("util").TextDecoder : TextDecoder;
  let ki = new Gu("utf-8", {
    ignoreBOM: true,
    fatal: true
  });
...
${t.stack}` : r;
  ...
  class ke {
    ...
    merge(e) {
      try {
        const i = h.__wbindgen_add_to_stack_pointer(-16);
        We(e, ke), h.automerge_merge(i, this.__wbg_ptr, e.__wbg_ptr);
        var n = y()[i / 4 + 0], r = y()[i / 4 + 1], s = y()[i / 4 + 2];
        if (s) throw A(r);
        return A(n);
      } finally {
    ...
    receiveSyncMessage(e, n) {
      try {
        const i = h.__wbindgen_add_to_stack_pointer(-16);
        We(e, me), h.automerge_receiveSyncMessage(i, this.__wbg_ptr, e.__wbg_ptr, w(n));
        var r = y()[i / 4 + 0], s = y()[i / 4 + 1];
        if (s) throw A(r);
      } finally {
        h.__wbindgen_add_to_stack_pointer(16);
  ...
  const T = await Vu({
  ...
  }, Wu), cd = T.memory, fd = T.__wbg_syncstate_free, ud = T.syncstate_sharedHeads, dd = T.syncstate_lastSentHeads, ld = T.syncstate_set_lastSentHeads, hd = T.syncstate_set_sentHashes, _d = T.syncstate_clone, gd = T.__wbg_automerge_free, pd = T.automerge_new, yd = T.automerge_clone, bd = T.automerge_fork, md = T.automerge_pendingOps, wd = T.automerge_commit, vd = T.automerge_merge, xd = T.automerge_rollback, Sd = T.automerge_keys, kd = T.automerge_text, Ad = T.automerge_spans, Ed = T.automerge_splice, Id = T.automerge_updateText, Cd = T.automerge_updateSpans, Od = T.automerge_push, Td = T.automerge_pushObject, Rd = T.automerge_insert, Md = T.automerge_splitBlock, jd = T.automerge_joinBlock, Dd = T.automerge_updateBlock, Ud = T.automerge_getBlock, Pd = T.automerge_insertObject, $d = T.automerge_put, Bd = T.automerge_putObject, Fd = T.automerge_increment, Ld = T.automerge_get, Hd = T.automerge_getWithType, Nd = T.automerge_objInfo, zd = T.automerge_getAll, Wd = T.automerge_enableFreeze, Vd = T.automerge_registerDatatype, Kd = T.automerge_applyPatches, Jd = T.automerge_applyAndReturnPatches, qd = T.automerge_diffIncremental, Gd = T.automerge_updateDiffCursor, Yd = T.automerge_resetDiffCursor, Xd = T.automerge_diff, Zd = T.automerge_isolate, Qd = T.automerge_integrate, el = T.automerge_length, tl = T.automerge_delete, nl = T.automerge_save, rl = T.automerge_saveIncremental, sl = T.automerge_saveSince, il = T.automerge_saveNoCompress, ol = T.automerge_saveAndVerify, al = T.automerge_loadIncremental, cl = T.automerge_applyChanges, fl = T.automerge_getChanges, ul = T.automerge_getChangeByHash, dl = T.automerge_getDecodedChangeByHash, ll = T.automerge_getChangesAdded, hl = T.automerge_getHeads, _l = T.automerge_getActorId, gl = T.automerge_getLastLocalChange, pl = T.automerge_dump, yl = T.automerge_getMissingDeps, bl = T.automerge_receiveSyncMessage, ml = T.automerge_generateSyncMessage, wl = T.automerge_toJS, vl = T.automerge_materialize, xl = T.automerge_getCursor, Sl = T.automerge_getCursorPosition, kl = T.automerge_emptyChange, Al = T.automerge_mark, El = T.automerge_unmark, Il = T.automerge_marks, Cl = T.automerge_marksAt, Ol = T.automerge_hasOurChanges, Tl = T.automerge_topoHistoryTraversal, Rl = T.automerge_stats, Ml = T.create, jl = T.load, Dl = T.encodeChange, Ul = T.decodeChange, Pl = T.initSyncState, $l = T.importSyncState, Bl = T.exportSyncState, Fl = T.encodeSyncMessage, Ll = T.decodeSyncMessage, Hl = T.encodeSyncState, Nl = T.decodeSyncState, zl = T.__wbindgen_malloc, Wl = T.__wbindgen_realloc, Vl = T.__wbindgen_add_to_stack_pointer, Kl = T.__wbindgen_free, Jl = T.__wbindgen_exn_store, ql = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wbg_automerge_free: gd,
    __wbg_syncstate_free: fd,
    __wbindgen_add_to_stack_pointer: Vl,
    __wbindgen_exn_store: Jl,
    __wbindgen_free: Kl,
    __wbindgen_malloc: zl,
    __wbindgen_realloc: Wl,
    automerge_applyAndReturnPatches: Jd,
    automerge_applyChanges: cl,
    automerge_applyPatches: Kd,
    automerge_clone: yd,
    automerge_commit: wd,
    automerge_delete: tl,
    automerge_diff: Xd,
    ...
    automerge_enableFreeze: Wd,
    automerge_fork: bd,
    automerge_generateSyncMessage: ml,
    automerge_get: Ld,
    automerge_getActorId: _l,
    automerge_getAll: zd,
    automerge_getBlock: Ud,
    automerge_getChangeByHash: ul,
    automerge_getChanges: fl,
    automerge_getChangesAdded: ll,
    automerge_getCursor: xl,
    automerge_getCursorPosition: Sl,
    automerge_getDecodedChangeByHash: dl,
    automerge_getHeads: hl,
    automerge_getLastLocalChange: gl,
    automerge_getMissingDeps: yl,
    automerge_getWithType: Hd,
    automerge_hasOurChanges: Ol,
    automerge_increment: Fd,
    automerge_insert: Rd,
    automerge_insertObject: Pd,
    automerge_integrate: Qd,
    automerge_isolate: Zd,
    automerge_joinBlock: jd,
    automerge_keys: Sd,
    automerge_length: el,
    automerge_loadIncremental: al,
    automerge_mark: Al,
    automerge_marks: Il,
    automerge_marksAt: Cl,
    automerge_materialize: vl,
    automerge_merge: vd,
    automerge_new: pd,
    automerge_objInfo: Nd,
    automerge_pendingOps: md,
    automerge_push: Od,
    automerge_pushObject: Td,
    automerge_put: $d,
    automerge_putObject: Bd,
    automerge_receiveSyncMessage: bl,
    automerge_registerDatatype: Vd,
    automerge_resetDiffCursor: Yd,
    automerge_rollback: xd,
    automerge_save: nl,
    automerge_saveAndVerify: ol,
    automerge_saveIncremental: rl,
    automerge_saveNoCompress: il,
    automerge_saveSince: sl,
    automerge_spans: Ad,
    automerge_splice: Ed,
    automerge_splitBlock: Md,
    automerge_stats: Rl,
    automerge_text: kd,
    automerge_toJS: wl,
    automerge_topoHistoryTraversal: Tl,
    automerge_unmark: El,
    automerge_updateBlock: Dd,
    automerge_updateDiffCursor: Gd,
    automerge_updateSpans: Cd,
    automerge_updateText: Id,
    create: Ml,
    decodeChange: Ul,
    decodeSyncMessage: Ll,
    decodeSyncState: Nl,
    encodeChange: Dl,
    encodeSyncMessage: Fl,
    encodeSyncState: Hl,
    exportSyncState: Bl,
    importSyncState: $l,
    initSyncState: Pl,
  ...
  const Gl = Object.freeze(Object.defineProperty({
    ...
    create: Yu,
    decodeChange: Qu,
    decodeSyncMessage: sd,
    decodeSyncState: od,
    encodeChange: Zu,
    encodeSyncMessage: rd,
    encodeSyncState: id,
    exportSyncState: nd,
    importSyncState: td,
    initSyncState: ed,
  ...
  const In = tt, Xl = (t) => t.type === "peer", Zl = (t) => t.type === "error", Ql = "1";
...
`), nh = (t) => {
  ...
  class sh extends rh {
    constructor(e, n = 5e3) {
      super();
      __privateAdd(this, _sh_instances);
    ...
    connect(e, n) {
      !this.socket || !this.peerId ? (__privateGet(this, _n9).call(this, "connecting"), this.peerId = e, this.peerMetadata = n ?? {}) : (__privateGet(this, _n9).call(this, "reconnecting"), xe(e === this.peerId), this.socket.removeEventListener("open", this.onOpen), this.socket.removeEventListener("close", this.onClose), this.socket.removeEventListener("message", this.onMessage), this.socket.removeEventListener("error", this.onError)), __privateGet(this, _e9) || __privateSet(this, _e9, setInterval(() => {
        this.connect(e, n);
      }, this.retryInterval)), this.socket = new In(this.url), this.socket.binaryType = "arraybuffer", this.socket.addEventListener("open", this.onOpen), this.socket.addEventListener("close", this.onClose), this.socket.addEventListener("message", this.onMessage), this.socket.addEventListener("error", this.onError), setTimeout(() => __privateMethod(this, _sh_instances, r_fn2).call(this), 1e3), this.join();
    }
    join() {
      xe(this.peerId), xe(this.socket), this.socket.readyState === In.OPEN && this.send(ih(this.peerId, this.peerMetadata));
    }
    disconnect() {
    ...
    send(e) {
      ...
      const n = pi(e);
      this.socket.send(nh(n));
    }
    peerCandidate(e, n) {
      xe(this.socket), __privateMethod(this, _sh_instances, r_fn2).call(this), this.remotePeerId = e, this.emit("peer-candidate", {
        peerId: e,
        peerMetadata: n
      });
    }
    receiveMessage(e) {
      ...
      } else Zl(n) ? __privateGet(this, _n9).call(this, `error: ${n.message}`) : this.emit("message", n);
    }
  }
  _t9 = new WeakMap();
  _e9 = new WeakMap();
  _n9 = new WeakMap();
  _sh_instances = new WeakSet();
  r_fn2 = function() {
  ...
  je("WebsocketServer");
  const Or = new AudioContext({
    latencyHint: "balanced",
    sampleRate: ca
  });
  await Or.audioWorklet.addModule(Oa);
  const Tr = new AudioWorkletNode(Or, "looper"), oh = await fa(Or, Tr), ls = /* @__PURE__ */ new Set(), kt = {
    shared: {
      layers: []
    },
  ...
  pa(Tr, oh, kt, ch);
  function oa(t) {
    Tr.port.postMessage(t);
  }
  const hs = new Nu({
    storage: new Yl("automerge-demo"),
    network: [
      new sh("wss://sync.automerge.org")
    ]
  }), aa = await fh();
  ...
  async function fh() {
    ...
    let e;
    if (si(t)) console.log("loading existing doc"), e = hs.find(t), nr(await e.doc());
    else {
      console.log("creating new doc");
      const n = kt.shared;
      e = hs.create(n), document.location.hash = e.url, nr(n);
    }
    return e;
  }
})();
