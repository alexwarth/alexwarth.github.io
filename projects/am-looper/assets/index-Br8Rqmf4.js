...
(async () => {
  var _t2, _e2, _n2, _r2, _s2, _wu_instances, i_get, a_get, o_fn, c_fn, _t3, _e3, _n3, _r3, _s3, _i2, _Tu_instances, a_fn, o_fn2, _t4, _e4, _n4, _r4, _s4, _i3, _a2, _t5, _e5, _n5, _r5, _s5, _zu_instances, i_fn, a_fn2, o_fn3, c_fn2, _t6, _e6, _n6, _r6, _s6, _i4, _a3, _o2, _c2, _Wu_instances, g_fn, p_fn, y_fn, u_fn, b_fn, m_fn, d_fn, l_fn, h_fn, f_fn, __fn, _t7, _e7, _n7, _Vu_instances, r_fn, s_fn, i_fn2, _t8, _e8, _n8, _r7, _s7, _Ku_instances, i_fn3, _a4, o_fn4, c_fn3, _t9, _e9, _n9, _ch_instances, r_fn2;
  (function() {
  ...
  let Lt, Mn, je, sn;
  function wa(t, e, n, r) {
    Lt = t, window.looper = Lt, Mn = e, je = n, sn = r, Lt.port.onmessage = (o) => va(o.data);
    const s = bs().deviceSpecificLatencyOffset[Mn] ?? 20;
    Gt({
      command: "set latency offset",
      value: s
    }), window.addEventListener("keydown", xa), window.addEventListener("keyup", Sa), window.addEventListener("pointerdown", (o) => Ea(o.x / devicePixelRatio, o.y / devicePixelRatio, o)), window.addEventListener("pointermove", (o) => Ia(o.x / devicePixelRatio, o.y / devicePixelRatio));
    function i() {
      Ca(), requestAnimationFrame(i);
    }
    i(), ks();
  }
  function Gt(t) {
  ...
  function va(t) {
    switch (t.event) {
      ...
      case "changed latency offset":
        Dn(`latency offset = ${t.value}`), ma((e) => {
          e.deviceSpecificLatencyOffset[Mn] = t.value;
        });
        break;
      default:
  ...
  function ka() {
    ...
    }), Ht = false, Dn("stopped recording", "#888")) : (Gt({
      command: "start recording"
    }), Ht = true, Dn("recording...", "red")), ks();
  }
  let yt = null;
  function ws(t) {
    if (t === "up") {
  ...
  function xs(t) {
    ...
    for (; i < n.length; ) {
      let o = 0;
      for (let a = 0; a < Rn; a++) for (let c = 0; c < t.numChannels; c++) {
  ...
  let Be = null, Ke = 1;
  function Ca() {
    Be = pa(je.shared.layers), Be !== null && (Ke = (innerWidth - 2 * Nt) / Be), G.clearRect(0, 0, innerWidth, innerHeight), Oa(), Ma(), Ta();
  }
  const We = 32, Ss = We / 2, Nt = 100;
  function Oa() {
    if (Be === null) return;
    const t = je.shared.layers;
    let e = 2 * We;
    const n = Nt, r = n + Be * Ke;
    for (let i = 0; i < t.length; i++) {
      const o = t[i], a = xs(o), c = o.muted ? 0.25 : 1;
      let f = e;
      for (let _ = 0; _ < o.numFramesRecorded / Be; _++) {
        let l = e, b = n + (o.frameOffset + Be) % Be * Ke;
        for (let v = 0; v < a.maxAmplitudesInChunks.length; v++) {
          b >= r && (b = n, l += We), G.lineWidth = Rn * Ke, G.strokeStyle = `rgba(100, 149, 237, ${c})`, G.beginPath();
          const S = a.maxAmplitudesInChunks[v] / a.maxAmplitudeInLayer * We / 2;
          G.moveTo(b, l - S / 2), G.lineTo(b, l + S / 2), G.stroke(), b += Rn * Ke;
        }
        f = l;
      }
  ...
  function Dn(t, e = "cornflowerblue", n = 3e3) {
  ...
  const ja = "" + new URL("worklet-DH89herY.js", import.meta.url).href, Le = Symbol.for("_am_meta"), at = Symbol.for("_am_trace"), ct = Symbol.for("_am_objectId"), on = Symbol.for("_am_isProxy"), Es = Symbol.for("_am_clearCache"), Da = Symbol.for("_am_uint"), Ua = Symbol.for("_am_int"), Pa = Symbol.for("_am_f64"), Is = Symbol.for("_am_counter"), $a = Symbol.for("_am_text");
  class Me {
    constructor(e) {
  ...
  function Xt(t, e, n, r) {
    ...
    switch (s) {
      case "object":
        ...
        throw an(t, r) ? new RangeError("Cannot create a reference to an existing document object") : new RangeError(`Cannot assign unknown object: ${t}`);
      case "boolean":
        return [
          t,
          "boolean"
  ...
  const La = {
    get(t, e) {
      ...
      return e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === ct ? r : e === on ? true : e === at ? t.trace : e === Le ? {
        handle: n,
        textV2: t.textV2
      } : (s[e] || (s[e] = ge(t, e)), s[e]);
    },
    set(t, e, n) {
      ...
      if (t.cache = {}, an(n, r)) throw new RangeError("Cannot create a reference to an existing document object");
      ...
      switch (c) {
        case "list": {
          const f = r.putObject(s, e, []), u = cn(r, f, o, [
            ...i,
            e
          ]);
    ...
    get(t, e) {
      const { context: n, objectId: r } = t;
      return e = Ae(e), e === Symbol.hasInstance ? (s) => Array.isArray(s) : e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === ct ? r : e === on ? true : e === at ? t.trace : e === Le ? {
        handle: n
      } : e === "length" ? n.length(r) : typeof e == "number" ? ge(t, e) : cr(t)[e];
    },
    set(t, e, n) {
      const { context: r, objectId: s, path: i, textV2: o } = t;
      if (e = Ae(e), an(n, r)) throw new RangeError("Cannot create a reference to an existing document object");
      if (e === Es) return true;
      if (e === at) return t.trace = n, true;
      ...
      switch (c) {
        case "list": {
          let f;
          e >= r.length(s) ? f = r.insertObject(s, e, []) : f = r.putObject(s, e, []), cn(r, f, o, [
            ...i,
            e
          ]).splice(0, 0, ...a);
          break;
        ...
        case "text": {
          if (o) Zt(a), e >= r.length(s) ? r.insertObject(s, e, a) : r.putObject(s, e, a);
            ...
            let f;
            fr(a), e >= r.length(s) ? f = r.insertObject(s, e, "") : f = r.putObject(s, e, ""), vt(r, f, [
              ...i,
              e
            ]).splice(0, 0, ...a);
          }
    ...
    get(t, e) {
      ...
      return e = Ae(e), e === Symbol.hasInstance ? (s) => Array.isArray(s) : e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === ct ? r : e === on ? true : e === at ? t.trace : e === Le ? {
        handle: n
      } : e === "length" ? n.length(r) : typeof e == "number" ? ge(t, e) : za(t)[e] || cr(t)[e];
    },
    getPrototypeOf() {
  ...
  function Ct(t, e, n, r) {
    ...
    return Object.assign(i, s), new Proxy(i, La);
  }
  function cn(t, e, n, r) {
    const s = {
      context: t,
  ...
  function vt(t, e, n) {
    ...
    return Object.assign(s, r), new Proxy(s, Ha);
  }
  function Na(t, e) {
    return Ct(t, "_root", e, []);
  }
  function cr(t) {
    ...
    return {
      ...
      splice(o, a, ...c) {
        ...
        for (const d of c) if (an(d, e)) throw new RangeError("Cannot create a reference to an existing document object");
        const f = [];
        for (let d = 0; d < a; d++) {
          const _ = ge(t, o);
  ...
  function za(t) {
    ...
    return {
      ...
      insertAt(s, ...i) {
        i.every((o) => typeof o == "string") ? e.splice(n, s, 0, i.join("")) : cr(t).insertAt(s, ...i);
      }
    };
  }
  function fr(t) {
  ...
  const Ga = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Hr = {
    randomUUID: Ga
  };
  function Ts(t, e, n) {
    if (Hr.randomUUID && !e && !t) return Hr.randomUUID();
    t = t || {};
    const r = t.random || (t.rng || Va)();
  ...
  Ms.length;
  const pn = typeof TextEncoder < "u" ? new TextEncoder("utf-8") : {
    encode: () => {
      throw Error("TextEncoder not available");
    }
  };
  pn.encodeInto;
  const Ya = typeof TextDecoder < "u" ? new TextDecoder("utf-8", {
    ignoreBOM: true,
    fatal: true
  }) : {
    decode: () => {
  ...
  function ae(t, e = true) {
    ...
    if (n === void 0 || n == null || e && Qa(t) !== "_root") throw new RangeError("must be the document root");
    return n;
  }
  function js(t) {
  ...
  function dr(t) {
    const e = ur(t), n = !!e.freeze, r = e.patchCallback, s = !e.enableTextV2, i = e.actor, o = de.create({
      actor: i,
      text_v1: s
    });
  ...
  function tc(t, e) {
    const n = ae(t), r = n.heads, s = ur(e), i = n.handle.fork(s.actor, r);
    i.updateDiffCursor();
    const o = ec(n, [
      "heads"
    ]);
  ...
  function nc(t, e) {
    return xt(dr(e), "from", {}, (n) => Object.assign(n, t)).newDoc;
  }
  function rc(t, e, n) {
  ...
  function xt(t, e, n, r, s) {
    ...
    if (un(t)) throw new RangeError("Calls to Automerge.change cannot be nested");
    let o = i.handle.getHeads();
    s && fc(s, o) && (s = void 0), s && (i.handle.isolate(s), o = s), "time" in n || (n.time = Math.floor(Date.now() / 1e3));
    try {
      i.heads = o;
      const a = Na(i.handle, i.textV2);
  ...
  function oc(t, e) {
    const n = ur(e), r = n.actor, s = n.patchCallback, i = !n.enableTextV2, o = n.unchecked || false, a = n.allowMissingChanges || false, c = n.convertRawStringsToText || false, f = de.load(t, {
      text_v1: i,
      actor: r,
      unchecked: o,
      allowMissingDeps: a,
  ...
  function cc(t, e, n) {
    ...
    const r = ae(t);
    return r.mostRecentPatch && $n(r.mostRecentPatch.before, e) && $n(r.mostRecentPatch.after, n) ? r.mostRecentPatch.patches : r.handle.diff(e, n);
  }
  function fc(t, e) {
  ...
  function $n(t, e) {
    ...
    for (let s = 0; s < n.length; s++) if (n[s] !== r[s] || !$n(t[n[s]], e[r[s]])) return false;
    return true;
  }
  function Ps(t) {
  ...
  function Bs(t, e) {
    t.registerDatatype("counter", (n) => new Un(n), (n) => {
      if (n instanceof Un) return n.value;
    }), e ? t.registerDatatype("str", (n) => new Pn(n), (n) => {
      if (n instanceof Pn) return n.val;
  ...
  function dn(t) {
    const e = ln(t);
    return e.enableTextV2 = true, dr(e);
  }
  function Wr(t, e) {
    const n = ln(e);
    return n.enableTextV2 = true, tc(t, n);
  }
  function gc(t, e) {
    const n = ln(e);
  ...
  function pc(t, e) {
    const n = ln(e);
    return n.enableTextV2 = true, n.patchCallback ? Ds(dr(n), t) : oc(t, n);
  }
  function ln(t) {
    return {
      actor: t
  ...
  const Ls = ".", Ec = "", Hs = "", Ic = "#", Fn = "*", Ns = "xstate.init", Ln = "xstate.stop";
  function Cc(t, e) {
    return {
  ...
  const Rc = typeof Symbol == "function" && Symbol.observable || "@@observable";
  function Ws(t, e) {
    const n = Jr(t), r = Jr(e);
 ...
 - ${s}: ${i.toString().replace(/\n\s*/g, "")}`).join("")}`), t);
  ...
  class $c {
    constructor(e, n) {
      ...
      this.system = o ? o.system : Uc(this, {
        clock: s,
        logger: i
    ...
    update(e, n) {
      ...
      switch (this._snapshot.status) {
        ...
        case "done":
          ...
          this._stopProcedure(), this._complete(), this._doneEvent = Oc(this.id, this._snapshot.output), this._parent && this.system._relay(this, this._parent, this._doneEvent);
          break;
        case "error":
    ...
    _process(e) {
      ...
      this.update(n, e), e.type === Ln && (this._stopProcedure(), this._complete());
    }
    _stop() {
    ...
    _error(e) {
      this._stopProcedure(), this._reportError(e), this._parent && this.system._relay(this, this._parent, Tc(this.id, e));
    }
    _stopProcedure() {
...
Event: ${n}`);
  ...
  function Lc(t) {
    ...
    return e.type = "xstate.cancel", e.sendId = t, e.resolve = Bc, e.execute = Fc, e;
  }
  function Hc(t, e, n, r, { id: s, systemId: i, src: o, input: a, syncSnapshot: c }) {
    const f = typeof o == "string" ? _r(e.machine, o) : o, u = typeof s == "function" ? s(n) : s;
    let d, _;
  ...
  function zc(...[t, { id: e, systemId: n, input: r, syncSnapshot: s = false } = {}]) {
    ...
    return i.type = "xstate.spawnChild", i.id = e, i.systemId = n, i.src = t, i.input = r, i.syncSnapshot = s, i.resolve = Hc, i.execute = Nc, i;
  }
  function Wc(t, e, n, r, { actorRef: s }) {
  ...
  function qs(t) {
    ...
    return e.type = "xstate.stopChild", e.actorRef = t, e.resolve = Wc, e.execute = Vc, e;
  }
  function pr(t, e, n, r) {
    ...
    if (typeof o != "function") return pr(o, e, n, r);
    const a = {
      context: e,
      event: n
  ...
  const yr = (t) => t.type === "atomic" || t.type === "final";
  function ft(t) {
  ...
  function br(t, e) {
    return e.type === "compound" ? ft(e).some((n) => n.type === "final" && t.has(n)) : e.type === "parallel" ? ft(e).every((n) => br(t, n)) : e.type === "final";
  }
  const hn = (t) => t[0] === Ic;
  function Kc(t, e) {
  ...
  function Je(t, e, n) {
    const r = Js(n.target), s = n.reenter ?? false, i = Yc(t, r);
  ...
  function Yc(t, e) {
    if (e !== void 0) return e.map((n) => {
      ...
      if (hn(n)) return t.machine.getStateNodeById(n);
      const r = n[0] === Ls;
...
${i.message}`);
  ...
  function ut(t, e) {
    if (hn(e)) return t.machine.getStateNodeById(e);
  ...
  function Zc(t, e, n, r) {
    const s = Object.keys(e), i = ut(t, s[0]), o = mr(i, e[s[0]], n, r);
  ...
  function Qc(t, e, n, r) {
    ...
    for (const i of Object.keys(e)) {
      const o = e[i];
      if (!o) continue;
      const a = ut(t, i), c = mr(a, o, n, r);
      c && s.push(...c);
    }
    return s.length ? s : t.next(n, r);
  }
  function mr(t, e, n, r) {
    return typeof e == "string" ? Xc(t, e, n, r) : Object.keys(e).length === 1 ? Zc(t, e, n, r) : Qc(t, e, n, r);
  }
  function ef(t) {
  ...
  function wr(t, e) {
    ...
    else for (const s of wr(Zs(r), e)) n.add(s);
    else n.add(r);
    return [
      ...n
    ];
  ...
  function Vn(t, e, n, r, s, i) {
    ...
    const c = ei(t, o, a);
    let f = e;
    s || ([f, a] = cf(f, r, n, c, o, a, i, n.actionExecutor)), f = dt(f, r, n, c.flatMap((d) => d.actions), i, void 0), f = of(f, r, n, c, o, i, a, s);
    const u = [
      ...o
    ];
    f.status === "done" && (f = dt(f, r, n, u.sort((d, _) => _.order - d.order).flatMap((d) => d.exit), i, void 0));
    try {
      return a === e.historyValue && rf(e._nodes, o) ? f : Xe(f, {
        _nodes: u,
        historyValue: a
      });
    } catch (d) {
  ...
  function sf(t, e, n, r, s) {
    ...
    const i = Hn(s.id, s.output !== void 0 && s.parent ? Nn(s.output, t.context, e, n.self) : void 0);
    return Nn(r.output, t.context, i, n.self);
  }
  function of(t, e, n, r, s, i, o, a) {
    ...
    for (const _ of [
      ...
      if (c = dt(c, e, n, l, i, _.invoke.map((b) => b.id)), _.type === "final") {
        ...
        for ((b == null ? void 0 : b.type) === "compound" && i.push(Hn(b.id, _.output !== void 0 ? Nn(_.output, c.context, e, n.self) : void 0)); (v == null ? void 0 : v.type) === "parallel" && !d.has(v) && br(s, v); ) d.add(v), i.push(Hn(v.id)), S = v, v = v.parent;
        if (v) continue;
        c = Xe(c, {
          status: "done",
  ...
  function cf(t, e, n, r, s, i, o, a) {
    ...
    let u;
    for (const d of f) for (const _ of ef(d)) {
      let l;
      _.history === "deep" ? l = (b) => yr(b) && Ne(b, d) : l = (b) => b.parent === d, u ?? (u = {
        ...i
  ...
  function ri(t, e, n, r, s, i) {
    ...
    let a = t;
    for (const c of r) {
      const f = typeof c == "function", u = f ? c : ff(o, typeof c == "string" ? c : c.type), d = {
        context: a.context,
        event: e,
        self: n.self,
        system: n.system
  ...
  function mn(t, e, n, r) {
    if (e.type === Fn) throw new Error(`An event cannot have the wildcard type ('${Fn}')`);
    let s = t;
    const i = [];
    function o(f, u, d) {
    ...
    if (e.type === Ln) return s = Xe(Zr(s, e, n), {
      status: "stopped"
    }), o(s, e, []), {
      snapshot: s,
      microstates: i
    ...
    for (; s.status === "active"; ) {
      ...
      s = Vn(f, s, n, a, false, r), c = s !== u, o(s, a, f);
    }
  ...
  function uf(t, e) {
    const n = /* @__PURE__ */ new Set(), r = t._nodes.filter(yr);
    for (const s of r) e: for (const i of [
      s
    ].concat(Tt(s, void 0))) if (i.always) {
      for (const o of i.always) if (o.guard === void 0 || pr(o.guard, t.context, e, t)) {
        n.add(o);
        break e;
      }
    }
  ...
  function vf(t, e) {
    ...
    return n.type = "xstate.raise", n.event = t, n.id = e == null ? void 0 : e.id, n.delay = e == null ? void 0 : e.delay, n.resolve = mf, n.execute = wf, n;
  }
  function xf(t, { machine: e, context: n }, r, s) {
    const i = (o, a) => {
      if (typeof o == "string") {
        const c = _r(e, o);
  ...
  function Kn(t) {
    ...
    return e.type = "xstate.assign", e.assignment = t, e.resolve = Sf, e;
  }
  function kf(t, e) {
    const n = Re(e);
  ...
  class vr {
    constructor(e, n) {
      if (this.config = e, this.key = void 0, this.id = void 0, this.type = void 0, this.path = void 0, this.states = void 0, this.history = void 0, this.entry = void 0, this.exit = void 0, this.parent = void 0, this.machine = void 0, this.meta = void 0, this.output = void 0, this.order = -1, this.description = void 0, this.tags = [], this.transitions = void 0, this.always = void 0, this.parent = n._parent, this.key = n._key, this.machine = n._machine, this.path = this.parent ? this.parent.path.concat(this.key) : [], this.id = this.config.id || [
        this.machine.id,
        ...this.path
      ].join(Ls), this.type = this.config.type || (this.config.states && Object.keys(this.config.states).length ? "compound" : this.config.history ? "history" : "atomic"), this.description = this.config.description, this.order = this.machine.idMap.size, this.machine.idMap.set(this.id, this), this.states = this.config.states ? qr(this.config.states, (r, s) => new vr(r, {
        _parent: this,
        _key: s,
        _machine: this.machine
      })) : Af, this.type === "compound" && !this.config.initial) throw new Error(`No initial state specified for compound state node "#${this.id}". Try adding { initial: "${Object.keys(this.states)[0]}" } to the state config.`);
    ...
    _initialize() {
      this.transitions = qc(this), this.config.always && (this.always = rt(this.config.always).map((e) => Je(this, Hs, e))), Object.keys(this.states).forEach((e) => {
    ...
    get after() {
      return et(this, "delayedTransitions", () => Jc(this));
    }
    get initial() {
      return et(this, "initial", () => Gc(this, this.config.initial));
    }
    next(e, n) {
      const r = n.type, s = [];
      let i;
      const o = et(this, `candidates-${r}`, () => Kc(this, r));
      for (const a of o) {
...
${d.message}`);
  ...
  class xr {
    ...
    resolveState(e) {
      const n = df(this.root, e.value), r = Qt(tn(this.root, n));
      return zt({
        _nodes: [
          ...r
        ],
        context: e.context || {},
        children: {},
        status: br(r, this.root) ? "done" : e.status || "active",
        output: e.output,
        error: e.error,
    ...
    transition(e, n, r) {
      return mn(e, n, r, []).snapshot;
    }
    microstep(e, n, r) {
      return mn(e, n, r, []).microstates;
    }
    ...
    getInitialSnapshot(e, n) {
      const r = zs(n), s = [], i = this.getPreInitialState(e, r, s), o = Vn([
        {
          target: [
            ...Qs(this.root)
          ],
      ...
      ], i, e, r, true, s), { snapshot: a } = mn(o, r, e, s);
      return a;
    }
    start(e) {
    ...
    getStateNodeById(e) {
      const n = hr(e), r = n.slice(1), s = hn(n[0]) ? n[0].slice(Ef.length) : n[0], i = this.idMap.get(s);
    ...
    restoreSnapshot(e, n) {
      ...
      Object.keys(s).forEach((c) => {
        const f = s[c], u = f.snapshot, d = f.src, _ = typeof d == "string" ? _r(this, d) : d;
        if (!_) return;
        const l = St(_, {
          id: c,
          parent: n.self,
        ...
        if (!o.has(c)) {
          ...
          for (const u in c) {
            ...
            if (d && typeof d == "object") {
              if ("xstate$$type" in d && d.xstate$$type === gr) {
                c[u] = f[d.id];
                continue;
              }
              a(d, f);
  ...
  function Cf({ schemas: t, actors: e, actions: n, guards: r, delays: s }) {
    return {
      createMachine: (i) => If({
        ...i,
        schemas: t
  ...
  function Mf(t) {
    ...
    Jn(t.outputLen), Jn(t.blockLen);
  }
  function jf(t, e = true) {
  ...
  _n.crypto = void 0;
  _n.crypto = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0;
  (function(t) {
  ...
  class $f extends _t.Hash {
    ...
    digestInto(e) {
      (0, wn.aexists)(this), (0, wn.aoutput)(e, this), this.finished = true;
  ...
  const vn = Qe, _e = Sr, Bf = new Uint32Array([
    1116352408,
    1899447441,
    3049323471,
    3921009573,
  ...
  class kr extends vn.HashMD {
    constructor() {
      super(64, 32, 8, false), this.A = Ue[0] | 0, this.B = Ue[1] | 0, this.C = Ue[2] | 0, this.D = Ue[3] | 0, this.E = Ue[4] | 0, this.F = Ue[5] | 0, this.G = Ue[6] | 0, this.H = Ue[7] | 0;
    }
    get() {
    ...
    process(e, n) {
      for (let d = 0; d < 16; d++, n += 4) Pe[d] = e.getUint32(n, false);
      for (let d = 16; d < 64; d++) {
        const _ = Pe[d - 15], l = Pe[d - 2], b = (0, _e.rotr)(_, 7) ^ (0, _e.rotr)(_, 18) ^ _ >>> 3, v = (0, _e.rotr)(l, 17) ^ (0, _e.rotr)(l, 19) ^ l >>> 10;
        Pe[d] = v + Pe[d - 7] + b + Pe[d - 16] | 0;
      }
      let { A: r, B: s, C: i, D: o, E: a, F: c, G: f, H: u } = this;
      for (let d = 0; d < 64; d++) {
        const _ = (0, _e.rotr)(a, 6) ^ (0, _e.rotr)(a, 11) ^ (0, _e.rotr)(a, 25), l = u + _ + (0, vn.Chi)(a, c, f) + Bf[d] + Pe[d] | 0, v = ((0, _e.rotr)(r, 2) ^ (0, _e.rotr)(r, 13) ^ (0, _e.rotr)(r, 22)) + (0, vn.Maj)(r, s, i) | 0;
  ...
  He.sha256 = (0, _e.wrapConstructor)(() => new kr());
  He.sha224 = (0, _e.wrapConstructor)(() => new Ff());
  function Lf(t) {
  ...
  var Hf = Lf;
  const Nf = Hf, zf = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
  var Wf = Nf(zf), xn = Wf, Vf = function(t) {
    function e(i) {
      var o = Uint8Array.from(i), a = t(o), c = o.length + 4, f = new Uint8Array(c);
      return f.set(o, 0), f.set(a.subarray(0, 4), o.length), xn.encode(f, c);
    }
    function n(i) {
    ...
    function r(i) {
      var o = xn.decodeUnsafe(i);
      if (o) return n(o);
    }
    function s(i) {
      var o = xn.decode(i), a = n(o);
  ...
  var qf = Kf(Jf);
  const ai = lr(qf), Ar = "automerge:", Er = (t) => {
    const e = new RegExp(`^${Ar}(\\w+)$`), [, n] = t.match(e) || [], r = n, s = ui(r);
    ...
    const e = t instanceof Uint8Array || typeof t == "string" ? t : "documentId" in t ? t.documentId : void 0, n = e instanceof Uint8Array ? qn(e) : typeof e == "string" ? e : void 0;
    if (n === void 0) throw new Error("Invalid documentId: " + e);
    return Ar + n;
  }, ci = (t) => {
    if (!t || !t.startsWith(Ar)) return false;
    const e = t;
    try {
      const { documentId: n } = Er(e);
      return fi(n);
    } catch {
      return false;
    }
  ...
  }, ui = (t) => ai.decodeUnsafe(t), qn = (t) => ai.encode(t), Sn = (t) => {
    if (t instanceof Uint8Array) return qn(t);
    if (ci(t)) return Er(t).documentId;
    if (fi(t)) return t;
    if (Gf(t)) {
  ...
  let U, Ye, x = 0;
  const Xf = 105, Zf = 57342, Qf = 57343, ns = 57337, rs = 6, tt = {};
  let gt = 11281e4, Ce = 1681e4, V = {}, ee, nn, rn = 0, kt = 0, re, pe, te = [], Yn = [], ue, oe, pt, ss = {
    useRecords: false,
    mapsAsObjects: true
  }, At = false, di = 2;
  try {
  ...
  class Et {
    ...
    decode(e, n) {
      if (U) return gi(() => (er(), this ? this.decode(e, n) : Et.prototype.decode.call(ss, e, n)));
    ...
    decodeMultiple(e, n) {
      ...
      try {
        let i = e.length;
        At = true;
        let o = this ? this.decode(e, i) : Tr.decode(e, i);
        if (n) {
          if (n(o) === false) return;
  ...
  function jt() {
    try {
      ...
      throw er(), (t instanceof RangeError || t.message.startsWith("Unexpected end of buffer")) && (t.incomplete = true), t;
    }
  }
  function K() {
    let t = U[x++], e = t >> 5;
    ...
    switch (e) {
      ...
      case 6:
        if (t >= ns) {
          let s = ee[t & 8191];
          if (s) return s.read || (s.read = Xn(s)), s.read();
          if (t < 65536) {
            if (t == Qf) {
              let i = ot(), o = K(), a = K();
              Qn(o, a);
              ...
              let i = ot(), o = K();
              for (let a = 2; a < i; a++) Qn(o++, K());
              return K();
            } else if (t == ns) return fu();
            if (V.getShared && (Cr(), s = ee[t & 8191], s)) return s.read || (s.read = Xn(s)), s.read();
          }
        }
        let r = te[t];
  ...
  function Zn(t) {
    ...
    if (t > 64 && Gn) return Gn.decode(U.subarray(x, x += t));
    const n = x + t, r = [];
    for (e = ""; x < n; ) {
      const s = U[x++];
      if (!(s & 128)) r.push(s);
  ...
  const Qn = (t, e) => {
    t = t - 57344;
    let n = ee[t];
    n && n.isShared && ((ee.restoreStructures || (ee.restoreStructures = []))[t] = n), ee[t] = e, e.read = Xn(e);
  };
  te[Xf] = (t) => {
  ...
  for (let t = 0; t < os.length; t++) cu(os[t], au[t]);
  function cu(t, e) {
  ...
  const Or = new Array(147);
  for (let t = 0; t < 256; t++) Or[t] = +("1e" + Math.floor(45.15 - t * 0.30103));
  let Tr = new Et({
    useRecords: false
  });
  const pi = Tr.decode;
  ...
  let tr, yi;
  const gn = typeof globalThis == "object" && globalThis.Buffer, Rt = typeof gn < "u", kn = Rt ? gn.allocUnsafeSlow : Uint8Array, as = Rt ? gn : Uint8Array, cs = 256, fs = Rt ? 4294967296 : 2144337920;
  let An, m, Q, g = 0, $e, ne = null;
  const uu = 61440, du = /[\u0080-\uFFFF]/, le = Symbol("record-id");
  class bi extends Et {
    constructor(e) {
      ...
      this.mapEncode = function(p, R) {
        ...
        if (m || (m = new kn(8192), Q = new DataView(m.buffer, 0, 8192), g = 0), $e = m.length - 10, $e - g < 2048 ? (m = new kn(m.length), Q = new DataView(m.buffer, 0, m.length), $e = m.length - 10, g = 0) : R === ls && (g = g + 7 & 2147483640), n = g, c.useSelfDescribedHeader && (Q.setUint32(g, 3654940416), g += 3), o = c.structuredClone ? /* @__PURE__ */ new Map() : null, c.bundleStrings && typeof p != "string" ? (ne = [], ne.size = 1 / 0) : ne = null, r = c.structures, r) {
          if (r.uninitialized) {
            let C = c.getShared() || {};
        ...
        try {
          ...
          if (E(p), ne && ds(n, E), c.offset = g, o && o.idsToInsert) {
            g += o.idsToInsert.length * 2, g > $e && H(g), c.offset = g;
            let k = _u(m.subarray(n, g), o.idsToInsert);
            return o = null, k;
          }
      ...
      const E = (p) => {
        ...
        if (R === "string") {
          ...
          if (ne && C >= 4 && C < 1024) {
            if ((ne.size += C) > uu) {
              ...
              g + z > $e && (m = H(g + z)), m[g++] = 217, m[g++] = 223, m[g++] = 249, m[g++] = ne.position ? 132 : 130, m[g++] = 26, N = g - n, g += 4, ne.position && ds(n, E), ne = [
                "",
                ""
          ...
          if ((C = this.useFloat32) > 0 && p < 4294967296 && p >= -2147483648) {
            ...
            let O;
            if (C < 4 || (O = p * Or[(m[g] & 127) << 1 | m[g + 1] >> 7]) >> 0 === O) {
              g += 4;
              return;
            } else g--;
          }
          ...
          if (C === Object) L(p);
            ...
            if (p[Symbol.asyncIterator] || En(p)) {
        ...
        if (this.keyMap) {
          ...
          for (let J = 0; J < B; J++) {
            let Ur = N[J];
            k = C[Ur], k || (k = C[Ur] = /* @__PURE__ */ Object.create(null), O++), C = k;
          }
        ...
        let k = new kn(R);
        return Q = new DataView(k.buffer, 0, R), m.copy ? m.copy(k, 0, n, p) : k.set(m.slice(n, p)), g -= n, n = 0, $e = k.length - 10, m = k;
      };
      let $ = 100, q = 1e3;
      ...
      function* W(p, R, k) {
        ...
        if (C === Object) {
          ...
          m[g++] = 255;
        } else En(p) ? (us(p.size, 64), yield m.subarray(n, g), yield p, Z()) : p[Symbol.asyncIterator] ? (m[g++] = 159, yield m.subarray(n, g), yield p, Z(), m[g++] = 255) : E(p);
      ...
      function I(p, R, k) {
        return R && R.chunkThreshold ? $ = q = R.chunkThreshold : $ = 100, p && typeof p == "object" ? (c.encode(null, In), k(p, c.iterateProperties || (c.iterateProperties = {}), true)) : [
          c.encode(p)
        ];
      }
  ...
  const lu = typeof Blob > "u" ? function() {
  } : Blob;
  function En(t) {
    if (t instanceof lu) return true;
  ...
  const hu = new Uint8Array(new Uint16Array([
    1
  ]).buffer)[0] == 1;
  yi = [
    Date,
  ...
  function ve(t, e) {
    return !hu && e > 1 && (t -= 4), {
      ...
      encode: function(r, s) {
        ...
        s(Rt ? gn.from(a, o, i) : new Uint8Array(a, o, i));
      }
    };
  }
  function nr(t, e) {
  ...
  Rr.encode;
  Rr.encodeAsIterable;
  Rr.encodeAsAsyncIterable;
  const ls = 512, gu = 1024, In = 2048;
  function wi(t) {
    return new bi({
      tagUint8Array: false,
      useRecords: false
  ...
  const yu = (t, e) => t.length === e.length && t.every((n, r) => n === e[r]), Mr = (t, e) => yu(t, e), bu = async (t, e) => {
    let n;
  ...
  class wu extends lt {
    constructor(e, n = {}) {
      ...
      s ? (r = gc(n.initialValue), r = ic(r)) : r = dn(), __privateSet(this, _t2, De(`automerge-repo:dochandle:${this.documentId.slice(0, 5)}`));
      const i = __privateGet(this, _r2), o = Cf({
        types: {
          context: {},
          events: {}
        },
        actions: {
          onUpdate: Kn(({ context: a, event: c }) => {
            const f = a.doc;
            kf(c, Pt);
    ...
    async whenReady(e = [
      ...
      await bu(__privateMethod(this, _wu_instances, o_fn).call(this, e), __privateGet(this, _r2));
    }
    async doc(e = [
      "ready",
      "unavailable"
    ...
    heads() {
      if (this.isReady()) return we(__privateGet(this, _wu_instances, i_get));
    }
    update(e) {
  ...
  o_fn = function(e) {
    ...
    return Tf(__privateGet(this, _e2), (r) => n.some((s) => r.matches(s)), {
  ...
  }, { IDLE: _h, LOADING: gh, AWAITING_NETWORK: ph, REQUESTING: Ut, READY: Cn, DELETED: yh, UNAVAILABLE: hs } = vu, xu = "CREATE", Su = "FIND", ku = "REQUEST", Au = "DOC_READY", Eu = "AWAIT_NETWORK", Iu = "NETWORK_READY", Pt = "UPDATE", Cu = "DELETE", Ou = "DOC_UNAVAILABLE";
  class Tu extends lt {
    constructor() {
      super(...arguments);
      __privateAdd(this, _Tu_instances);
      ...
      __privateAdd(this, _i2, De("automerge-repo:remote-heads-subscriptions"));
    }
    ...
    handleRemoteHeads(e) {
      ...
      const n = __privateMethod(this, _Tu_instances, o_fn2).call(this, e);
      ...
      for (const r of n) {
        ...
        if (s) for (const i of s) __privateMethod(this, _Tu_instances, a_fn).call(this, i, r.documentId) && this.emit("notify-remote-heads", {
          targetId: i,
          documentId: r.documentId,
          heads: r.remoteHeads,
          timestamp: r.timestamp,
    ...
    handleImmediateRemoteHeadsChanged(e, n, r) {
      ...
      if (o) for (const a of o) __privateMethod(this, _Tu_instances, a_fn).call(this, a, e) && this.emit("notify-remote-heads", {
        targetId: a,
        documentId: e,
        heads: r,
        timestamp: i,
  ...
  }, Ru = (t) => ju(t) || xi(t) || vi(t) || Mu(t) || Du(t) || Uu(t), Mu = (t) => t.type === "doc-unavailable", vi = (t) => t.type === "request", ju = (t) => t.type === "sync", xi = (t) => t.type === "ephemeral", Du = (t) => t.type === "remote-subscription-change", Uu = (t) => t.type === "remote-heads-changed", Pu = (t) => `${t.senderId}:${t.sessionId}`;
  class $u extends lt {
    constructor(e, n = Bu(), r) {
      super();
      ...
      this.peerId = n, this.peerMetadata = r, __privateSet(this, _t4, De(`automerge-repo:network:${this.peerId}`)), e.forEach((s) => this.addNetworkAdapter(s));
    }
    addNetworkAdapter(e) {
  ...
  class zu {
    constructor(e) {
      ...
      __privateAdd(this, _s5, De("automerge-repo:storage-subsystem"));
  ...
  i_fn = async function(e, n) {
    const r = _c(n, __privateGet(this, _e5).get(e) ?? []);
    if (r && r.length > 0) {
      const s = [
        e,
        "incremental",
  ...
  class Wu extends Ei {
    constructor({ handle: e, onLoadSyncState: n }) {
      ...
      __privateSet(this, _t6, De(`automerge-repo:docsync:${r}`)), e.on("change", rr(() => __privateMethod(this, _Wu_instances, g_fn).call(this), this.syncDebounceRate)), e.on("ephemeral-message-outbound", (s) => __privateMethod(this, _Wu_instances, p_fn).call(this, s)), (async () => (await e.doc([
        Cn,
        Ut
      ]), __privateMethod(this, _Wu_instances, __fn).call(this)))();
    }
    get peerStates() {
    ...
    beginSync(e) {
      const n = e.every((s) => __privateGet(this, _r6)[s] in [
        ...
        if (__privateSet(this, _a3, true), __privateMethod(this, _Wu_instances, f_fn).call(this), !(s === void 0 && n)) return s ?? dn();
      });
      __privateGet(this, _t6).call(this, `beginSync: ${e.join(", ")}`), e.forEach((s) => {
        __privateMethod(this, _Wu_instances, u_fn).call(this, s, (i) => {
          const o = $s(Ps(i));
          __privateMethod(this, _Wu_instances, d_fn).call(this, s, o), r.then((a) => {
            a && __privateMethod(this, _Wu_instances, l_fn).call(this, s, a);
          }).catch((a) => {
    ...
    receiveMessage(e) {
      switch (e.type) {
        ...
        case "doc-unavailable":
          __privateGet(this, _r6)[e.senderId] = "unavailable", __privateMethod(this, _Wu_instances, f_fn).call(this);
          break;
        default:
    ...
    receiveSyncMessage(e) {
      ...
      __privateMethod(this, _Wu_instances, __fn).call(this), __privateMethod(this, _Wu_instances, h_fn).call(this, e);
    }
  }
  _t6 = new WeakMap();
  _e6 = new WeakMap();
  ...
  g_fn = async function() {
    ...
    e !== void 0 && __privateGet(this, _e6).forEach((n) => __privateMethod(this, _Wu_instances, l_fn).call(this, n, e));
  };
  p_fn = async function({ data: e }) {
    __privateGet(this, _t6).call(this, "broadcastToPeers", __privateGet(this, _e6)), __privateGet(this, _e6).forEach((n) => __privateMethod(this, _Wu_instances, y_fn).call(this, n, e));
  };
  y_fn = function(e, n) {
  ...
  u_fn = function(e, n) {
    __privateMethod(this, _Wu_instances, b_fn).call(this, e), e in __privateGet(this, _r6) || (__privateGet(this, _r6)[e] = "unknown");
    ...
    s || (__privateGet(this, _c2).call(this, e).then((i) => {
      __privateMethod(this, _Wu_instances, m_fn).call(this, e, i ?? lc());
    }).catch((i) => {
  ...
  l_fn = function(e, n) {
    __privateGet(this, _t6).call(this, `sendSyncMessage ->${e}`), __privateMethod(this, _Wu_instances, u_fn).call(this, e, (r) => {
      const [s, i] = uc(n, r);
      if (i) {
        __privateMethod(this, _Wu_instances, d_fn).call(this, e, s);
  ...
  h_fn = function(e) {
    vi(e) && (__privateGet(this, _r6)[e.senderId] = "wants"), __privateMethod(this, _Wu_instances, f_fn).call(this), hc(e.data).heads.length > 0 && (__privateGet(this, _r6)[e.senderId] = "has"), __privateMethod(this, _Wu_instances, u_fn).call(this, e.senderId, (n) => {
      __privateGet(this, _o2).update((r) => {
        const [s, i] = dc(r, n, e.data);
        return __privateMethod(this, _Wu_instances, d_fn).call(this, e.senderId, i), __privateMethod(this, _Wu_instances, l_fn).call(this, e.senderId, r), s;
      }), __privateMethod(this, _Wu_instances, f_fn).call(this);
    });
  };
  f_fn = function() {
  ...
  __fn = function() {
    for (const e of __privateGet(this, _i4)) __privateMethod(this, _Wu_instances, h_fn).call(this, e.message);
    __privateSet(this, _i4, []);
  };
  const On = De("automerge-repo:collectionsync");
  class Vu extends Ei {
    constructor(e) {
      super();
    ...
    async receiveMessage(e) {
      On(`onSyncMessage: ${e.senderId}, ${e.documentId}, ${"data" in e ? e.data.byteLength + "bytes" : ""}`);
      const n = e.documentId;
      if (!n) throw new Error("received a message with an invalid documentId");
      __privateGet(this, _n7)[n] = true;
      const r = __privateMethod(this, _Vu_instances, r_fn).call(this, n);
      r.receiveMessage(e);
      const s = await __privateMethod(this, _Vu_instances, i_fn2).call(this, n);
      r.beginSync(s.filter((i) => !r.hasPeer(i)));
    }
    addDocument(e) {
      if (__privateGet(this, _n7)[e]) return;
      const n = __privateMethod(this, _Vu_instances, r_fn).call(this, e);
      __privateMethod(this, _Vu_instances, i_fn2).call(this, e).then((r) => {
        n.beginSync(r);
      });
    }
    removeDocument(e) {
    ...
    addPeer(e) {
      if (On(`adding ${e} & synchronizing with them`), !__privateGet(this, _t7).has(e)) {
    ...
    removePeer(e) {
      On(`removing peer ${e}`), __privateGet(this, _t7).delete(e);
  ...
  r_fn = function(e) {
    if (!__privateGet(this, _e7)[e]) {
      const n = this.repo.find(Ir({
        documentId: e
      }));
      __privateGet(this, _e7)[e] = __privateMethod(this, _Vu_instances, s_fn).call(this, n);
    }
  ...
  class Ku extends lt {
    constructor({ storage: e, network: n = [], peerId: r, sharePolicy: s, isEphemeral: i = e === void 0, enableRemoteHeadsGossiping: o = false } = {}) {
      ...
      __privateSet(this, _s7, o), __privateSet(this, _t8, De("automerge-repo:repo")), this.sharePolicy = s ?? this.sharePolicy, this.on("document", async ({ handle: u, isNew: d }) => {
        if (a) {
          const _ = ({ handle: l, doc: b }) => {
            a.saveDoc(l.documentId, b);
          };
          if (u.on("heads-changed", rr(_, this.saveDebounceRate)), d) await a.saveDoc(u.documentId, u.docSync());
          else {
      ...
      }), __privateSet(this, _n8, new Vu(this)), __privateGet(this, _n8).on("message", (u) => {
      ...
      this.networkSubsystem = f, f.on("peer", async ({ peerId: u, peerMetadata: d }) => {
        ...
        __privateMethod(this, _Ku_instances, i_fn3).call(this, u);
      }), __privateGet(this, _n8).on("sync-state", (u) => {
        __privateMethod(this, _Ku_instances, o_fn4).call(this, u);
        const d = __privateGet(this, _e8)[u.documentId], { storageId: _ } = this.peerMetadataByPeerId[u.peerId] || {};
        if (!_) return;
        const l = d.getRemoteHeads(_);
        u.syncState.theirHeads && (!l || !Mr(l, u.syncState.theirHeads)) && u.syncState.theirHeads && (d.setRemoteHeads(_, u.syncState.theirHeads), _ && __privateGet(this, _s7) && __privateGet(this, _r7).handleImmediateRemoteHeadsChanged(u.documentId, _, u.syncState.theirHeads));
    ...
    create(e) {
      const { documentId: n } = Er(Yf()), r = __privateMethod(this, _Ku_instances, c_fn3).call(this, {
        documentId: n,
        isNew: true,
        initialValue: e
      });
    ...
    find(e) {
      ...
      const r = __privateMethod(this, _Ku_instances, c_fn3).call(this, {
        documentId: n,
        isNew: false
      });
      return this.emit("document", {
    ...
    delete(e) {
      const n = Sn(e);
      __privateMethod(this, _Ku_instances, c_fn3).call(this, {
        documentId: n,
        isNew: false
    ...
    async export(e) {
      const n = Sn(e), s = await __privateMethod(this, _Ku_instances, c_fn3).call(this, {
        documentId: n,
        isNew: false
      }).doc();
      if (s) return Us(s);
  ...
  o_fn4 = function(e) {
    ...
    s || (s = __privateGet(this, _a4)[n] = rr(({ documentId: i, syncState: o }) => {
  ...
  const qu = "" + new URL("automerge_wasm_bg-BEjDkhWo.wasm", import.meta.url).href, Gu = async (t = {}, e) => {
    let n;
  ...
  const Xu = typeof TextEncoder > "u" ? (0, module.require)("util").TextEncoder : TextEncoder;
  let Jt = new Xu("utf-8");
  const Zu = typeof Jt.encodeInto == "function" ? function(t, e) {
  ...
  function Ee(t, e, n) {
    ...
    if (o !== r) {
      ...
      const a = Kt().subarray(s + o, s + r), c = Zu(t, a);
...
${t.stack}` : r;
  ...
  function aa(t, e) {
    const n = sr(M(e)), r = Ee(n, h.__wbindgen_malloc, h.__wbindgen_realloc), s = be;
    y()[t / 4 + 1] = s, y()[t / 4 + 0] = r;
  }
  function ca(t, e) {
  ...
  const T = await Gu({
  ...
  }, qu), ld = T.memory, hd = T.__wbg_syncstate_free, _d = T.syncstate_sharedHeads, gd = T.syncstate_lastSentHeads, pd = T.syncstate_set_lastSentHeads, yd = T.syncstate_set_sentHashes, bd = T.syncstate_clone, md = T.__wbg_automerge_free, wd = T.automerge_new, vd = T.automerge_clone, xd = T.automerge_fork, Sd = T.automerge_pendingOps, kd = T.automerge_commit, Ad = T.automerge_merge, Ed = T.automerge_rollback, Id = T.automerge_keys, Cd = T.automerge_text, Od = T.automerge_spans, Td = T.automerge_splice, Rd = T.automerge_updateText, Md = T.automerge_updateSpans, jd = T.automerge_push, Dd = T.automerge_pushObject, Ud = T.automerge_insert, Pd = T.automerge_splitBlock, $d = T.automerge_joinBlock, Bd = T.automerge_updateBlock, Fd = T.automerge_getBlock, Ld = T.automerge_insertObject, Hd = T.automerge_put, Nd = T.automerge_putObject, zd = T.automerge_increment, Wd = T.automerge_get, Vd = T.automerge_getWithType, Kd = T.automerge_objInfo, Jd = T.automerge_getAll, qd = T.automerge_enableFreeze, Gd = T.automerge_registerDatatype, Yd = T.automerge_applyPatches, Xd = T.automerge_applyAndReturnPatches, Zd = T.automerge_diffIncremental, Qd = T.automerge_updateDiffCursor, el = T.automerge_resetDiffCursor, tl = T.automerge_diff, nl = T.automerge_isolate, rl = T.automerge_integrate, sl = T.automerge_length, il = T.automerge_delete, ol = T.automerge_save, al = T.automerge_saveIncremental, cl = T.automerge_saveSince, fl = T.automerge_saveNoCompress, ul = T.automerge_saveAndVerify, dl = T.automerge_loadIncremental, ll = T.automerge_applyChanges, hl = T.automerge_getChanges, _l = T.automerge_getChangeByHash, gl = T.automerge_getDecodedChangeByHash, pl = T.automerge_getChangesAdded, yl = T.automerge_getHeads, bl = T.automerge_getActorId, ml = T.automerge_getLastLocalChange, wl = T.automerge_dump, vl = T.automerge_getMissingDeps, xl = T.automerge_receiveSyncMessage, Sl = T.automerge_generateSyncMessage, kl = T.automerge_toJS, Al = T.automerge_materialize, El = T.automerge_getCursor, Il = T.automerge_getCursorPosition, Cl = T.automerge_emptyChange, Ol = T.automerge_mark, Tl = T.automerge_unmark, Rl = T.automerge_marks, Ml = T.automerge_marksAt, jl = T.automerge_hasOurChanges, Dl = T.automerge_topoHistoryTraversal, Ul = T.automerge_stats, Pl = T.create, $l = T.load, Bl = T.encodeChange, Fl = T.decodeChange, Ll = T.initSyncState, Hl = T.importSyncState, Nl = T.exportSyncState, zl = T.encodeSyncMessage, Wl = T.decodeSyncMessage, Vl = T.encodeSyncState, Kl = T.decodeSyncState, Jl = T.__wbindgen_malloc, ql = T.__wbindgen_realloc, Gl = T.__wbindgen_add_to_stack_pointer, Yl = T.__wbindgen_free, Xl = T.__wbindgen_exn_store, Zl = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wbg_automerge_free: md,
    __wbg_syncstate_free: hd,
    __wbindgen_add_to_stack_pointer: Gl,
    __wbindgen_exn_store: Xl,
    __wbindgen_free: Yl,
    __wbindgen_malloc: Jl,
    __wbindgen_realloc: ql,
    automerge_applyAndReturnPatches: Xd,
    automerge_applyChanges: ll,
    automerge_applyPatches: Yd,
    automerge_clone: vd,
    automerge_commit: kd,
    automerge_delete: il,
    automerge_diff: tl,
    automerge_diffIncremental: Zd,
    automerge_dump: wl,
    automerge_emptyChange: Cl,
    automerge_enableFreeze: qd,
    automerge_fork: xd,
    automerge_generateSyncMessage: Sl,
    automerge_get: Wd,
    automerge_getActorId: bl,
    automerge_getAll: Jd,
    automerge_getBlock: Fd,
    automerge_getChangeByHash: _l,
    automerge_getChanges: hl,
    automerge_getChangesAdded: pl,
    automerge_getCursor: El,
    automerge_getCursorPosition: Il,
    automerge_getDecodedChangeByHash: gl,
    automerge_getHeads: yl,
    automerge_getLastLocalChange: ml,
    automerge_getMissingDeps: vl,
    automerge_getWithType: Vd,
    automerge_hasOurChanges: jl,
    automerge_increment: zd,
    automerge_insert: Ud,
    automerge_insertObject: Ld,
    automerge_integrate: rl,
    automerge_isolate: nl,
    automerge_joinBlock: $d,
    automerge_keys: Id,
    automerge_length: sl,
    automerge_loadIncremental: dl,
    automerge_mark: Ol,
    automerge_marks: Rl,
    automerge_marksAt: Ml,
    automerge_materialize: Al,
    automerge_merge: Ad,
    automerge_new: wd,
    automerge_objInfo: Kd,
    automerge_pendingOps: Sd,
    automerge_push: jd,
    automerge_pushObject: Dd,
    automerge_put: Hd,
    automerge_putObject: Nd,
    automerge_receiveSyncMessage: xl,
    automerge_registerDatatype: Gd,
    automerge_resetDiffCursor: el,
    automerge_rollback: Ed,
    automerge_save: ol,
    automerge_saveAndVerify: ul,
    automerge_saveIncremental: al,
    automerge_saveNoCompress: fl,
    ...
    automerge_text: Cd,
    automerge_toJS: kl,
    automerge_topoHistoryTraversal: Dl,
    automerge_unmark: Tl,
    automerge_updateBlock: Bd,
    automerge_updateDiffCursor: Qd,
    automerge_updateSpans: Md,
    automerge_updateText: Rd,
    create: Pl,
    decodeChange: Fl,
    decodeSyncMessage: Wl,
    decodeSyncState: Kl,
    encodeChange: Bl,
    ...
    memory: ld,
    syncstate_clone: bd,
    syncstate_lastSentHeads: gd,
    syncstate_set_lastSentHeads: pd,
    syncstate_set_sentHashes: yd,
    syncstate_sharedHeads: _d
  }, Symbol.toStringTag, {
    value: "Module"
  }));
  Ii(Zl);
  ...
  const Tn = st, th = (t) => t.type === "peer", nh = (t) => t.type === "error", rh = "1";
...
`), oh = (t) => {
  ...
  class ch extends ah {
    constructor(e, n = 5e3) {
      ...
      __privateAdd(this, _n9, De("automerge-repo:websocket:browser"));
    ...
    connect(e, n) {
      !this.socket || !this.peerId ? (__privateGet(this, _n9).call(this, "connecting"), this.peerId = e, this.peerMetadata = n ?? {}) : (__privateGet(this, _n9).call(this, "reconnecting"), xe(e === this.peerId), this.socket.removeEventListener("open", this.onOpen), this.socket.removeEventListener("close", this.onClose), this.socket.removeEventListener("message", this.onMessage), this.socket.removeEventListener("error", this.onError)), __privateGet(this, _e9) || __privateSet(this, _e9, setInterval(() => {
        this.connect(e, n);
      }, this.retryInterval)), this.socket = new Tn(this.url), this.socket.binaryType = "arraybuffer", this.socket.addEventListener("open", this.onOpen), this.socket.addEventListener("close", this.onClose), this.socket.addEventListener("message", this.onMessage), this.socket.addEventListener("error", this.onError), setTimeout(() => __privateMethod(this, _ch_instances, r_fn2).call(this), 1e3), this.join();
    }
    join() {
      xe(this.peerId), xe(this.socket), this.socket.readyState === Tn.OPEN && this.send(fh(this.peerId, this.peerMetadata));
    }
    disconnect() {
    ...
    send(e) {
      ...
      if (xe(this.peerId), xe(this.socket), this.socket.readyState !== Tn.OPEN) throw new Error(`Websocket not ready (${this.socket.readyState})`);
      const n = wi(e);
      this.socket.send(oh(n));
    }
    peerCandidate(e, n) {
      xe(this.socket), __privateMethod(this, _ch_instances, r_fn2).call(this), this.remotePeerId = e, this.emit("peer-candidate", {
        peerId: e,
        peerMetadata: n
      });
    }
  ...
  De("WebsocketServer");
  const jr = new AudioContext({
    latencyHint: "balanced",
    sampleRate: la
  });
  await jr.audioWorklet.addModule(ja);
  const Dr = new AudioWorkletNode(jr, "looper"), uh = await ha(jr, Dr), ps = /* @__PURE__ */ new Set(), It = {
    shared: {
      layers: []
    },
  ...
  wa(Dr, uh, It, lh);
  function ua(t) {
    Dr.port.postMessage(t);
  }
  const ys = new Ku({
    storage: new eh("automerge-demo"),
    network: [
      new ch("wss://sync.automerge.org")
    ]
  }), da = await hh();
  da.on("change", (t) => ir(t.doc));
  function ir(t) {
  ...
  async function hh() {
    ...
    let e;
    if (ci(t)) console.log("loading existing doc"), e = ys.find(t), ir(await e.doc());
    else {
      console.log("creating new doc");
      const n = It.shared;
      e = ys.create(n), document.location.hash = e.url, ir(n);
    }
    return e;
  }
})();
